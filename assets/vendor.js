...
return i||(t=n.body.appendChild(n.createElement(r)),i=de.css(t,"display"),t.parentNode.removeChild(t),"none"===i&&(i="block"),qe[r]=i,i)}function v(e,t){for(var n,r,i=[],o=0,s=e.length;o<s;o++)r=e[o],r.style&&(n=r.style.display,t?("none"===n&&(i[o]=Ie.get(r,"display")||null,i[o]||(r.style.display="")),""===r.style.display&&Ue(r)&&(i[o]=g(r))):"none"!==n&&(i[o]="none",Ie.set(r,"display",n)))
for(o=0;o<s;o++)null!=i[o]&&(e[o].style.display=i[o])
return e}function y(e,t){var n
return n=void 0!==e.getElementsByTagName?e.getElementsByTagName(t||"*"):void 0!==e.querySelectorAll?e.querySelectorAll(t||"*"):[],void 0===t||t&&i(e,t)?de.merge([e],n):n}function b(e,t){for(var n=0,r=e.length;n<r;n++)Ie.set(e[n],"globalEval",!t||Ie.get(t[n],"globalEval"))}function _(e,t,n,r,i){for(var o,s,a,u,l,c,f=t.createDocumentFragment(),p=[],h=0,d=e.length;h<d;h++)if((o=e[h])||0===o)if("object"===de.type(o))de.merge(p,o.nodeType?[o]:o)
else if($e.test(o)){for(s=s||f.appendChild(t.createElement("div")),a=(Ve.exec(o)||["",""])[1].toLowerCase(),u=Ge[a]||Ge._default,s.innerHTML=u[1]+de.htmlPrefilter(o)+u[2],c=u[0];c--;)s=s.lastChild
...
else if(l=de.contains(o.ownerDocument,o),s=y(f.appendChild(o),"script"),l&&b(s),n)for(c=0;o=s[c++];)Ke.test(o.type||"")&&n.push(o)
return f}function w(){return!0}function E(){return!1}function C(){try{return ne.activeElement}catch(e){}}function T(e,t,n,r,i,o){var s,a
...
if(p&&(o=_(t,e[0].ownerDocument,!1,e,i),s=o.firstChild,1===o.childNodes.length&&(o=s),s||i)){for(a=de.map(y(o,"script"),O),u=a.length;f<p;f++)l=o,f!==h&&(l=de.clone(l,!0,!0),u&&de.merge(a,y(l,"script"))),r.call(e[f],l,f)
if(u)for(c=a[a.length-1].ownerDocument,de.map(a,S),f=0;f<u;f++)l=a[f],Ke.test(l.type||"")&&!Ie.access(l,"globalEval")&&de.contains(c,l)&&(l.src?de._evalUrl&&de._evalUrl(l.src):n(l.textContent.replace(rt,""),c))}return e}function P(e,t,n){for(var r,i=t?de.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||de.cleanData(y(r)),r.parentNode&&(n&&de.contains(r.ownerDocument,r)&&b(y(r,"script")),r.parentNode.removeChild(r))
return e}function N(e,t,n){var r,i,o,s,a=e.style
return n=n||st(e),n&&(s=n.getPropertyValue(t)||n[t],""!==s||de.contains(e.ownerDocument,e)||(s=de.style(e,t)),!he.pixelMarginRight()&&ot.test(s)&&it.test(t)&&(r=a.width,i=a.minWidth,o=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=n.width,a.width=r,a.minWidth=i,a.maxWidth=o)),void 0!==s?s+"":s}function D(e,t){return{get:function(){return e()?void delete this.get:(this.get=t).apply(this,arguments)}}}function I(e){if(e in pt)return e
for(var t=e[0].toUpperCase()+e.slice(1),n=ft.length;n--;)if((e=ft[n]+t)in pt)return e}function j(e){var t=de.cssProps[e]
return t||(t=de.cssProps[e]=I(e)||e),t}function L(e,t,n){var r=He.exec(t)
...
return ot.test(o)?o:(r=s&&(he.boxSizingReliable()||o===e.style[t]),"auto"===o&&(o=e["offset"+t[0].toUpperCase()+t.slice(1)]),(o=parseFloat(o)||0)+M(e,t,n||(s?"border":"content"),r,i)+"px")}function H(e,t,n,r,i){return new H.prototype.init(e,t,n,r,i)}function B(){dt&&(!1===ne.hidden&&e.requestAnimationFrame?e.requestAnimationFrame(B):e.setTimeout(B,de.fx.interval),de.fx.tick())}function U(){return e.setTimeout(function(){ht=void 0}),ht=de.now()}function z(e,t){var n,r=0,i={height:e}
for(t=t?1:0;r<4;r+=2-t)n=Be[r],i["margin"+n]=i["padding"+n]=e
return t&&(i.opacity=i.width=e),i}function q(e,t,n){for(var r,i=(K.tweeners[t]||[]).concat(K.tweeners["*"]),o=0,s=i.length;o<s;o++)if(r=i[o].call(n,t,e))return r}function W(e,t,n){var r,i,o,s,a,u,l,c,f="width"in t||"height"in t,p=this,h={},d=e.style,m=e.nodeType&&Ue(e),g=Ie.get(e,"fxshow")
...
return de.map(c,q,l),de.isFunction(l.opts.start)&&l.opts.start.call(e,l),l.progress(l.opts.progress).done(l.opts.done,l.opts.complete).fail(l.opts.fail).always(l.opts.always),de.fx.timer(de.extend(u,{elem:e,anim:l,queue:l.opts.queue})),l}function G(e){return(e.match(ke)||[]).join(" ")}function $(e){return e.getAttribute&&e.getAttribute("class")||""}function Q(e,t,n,r){var i
if(Array.isArray(t))de.each(t,function(t,i){n||Ot.test(e)?r(e,i):Q(e+"["+("object"==typeof i&&null!=i?t:"")+"]",i,n,r)})
...
else try{t=s(t)}catch(e){return{state:"parsererror",error:s?e:"No conversion from "+u+" to "+o}}}return{state:"success",data:t}}var te=[],ne=e.document,re=Object.getPrototypeOf,ie=te.slice,oe=te.concat,se=te.push,ae=te.indexOf,ue={},le=ue.toString,ce=ue.hasOwnProperty,fe=ce.toString,pe=fe.call(Object),he={},de=function(e,t){return new de.fn.init(e,t)},me=/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g,ge=/^-ms-/,ve=/-([a-z])/g,ye=function(e,t){return t.toUpperCase()}
...
else if("object"!==t.nodeName.toLowerCase()){for((a=t.getAttribute("id"))?a=a.replace(be,_e):t.setAttribute("id",a=F),c=T(e),o=c.length;o--;)c[o]="#"+a+" "+f(c[o])
...
return n||(n=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1,1&n||!_.sortDetached&&t.compareDocumentPosition(e)===n?e===P||e.ownerDocument===H&&M(H,e)?-1:t===P||t.ownerDocument===H&&M(H,t)?1:A?J(A,e)-J(A,t):0:4&n?-1:1)}:function(e,t){if(e===t)return k=!0,0
...
d=m="only"===e&&!d&&"nextSibling"}return!0}if(d=[s?g.firstChild:g.lastChild],s&&y){for(p=g,f=p[F]||(p[F]={}),c=f[p.uniqueID]||(f[p.uniqueID]={}),l=c[e]||[],h=l[0]===B&&l[1],b=h&&l[2],p=h&&g.childNodes[h];p=++h&&p&&p[m]||(b=h=0)||d.pop();)if(1===p.nodeType&&++b&&p===t){c[e]=[B,h,b]
break}}else if(y&&(p=t,f=p[F]||(p[F]={}),c=f[p.uniqueID]||(f[p.uniqueID]={}),l=c[e]||[],h=l[0]===B&&l[1],b=h),!1===b)for(;(p=++h&&p&&p[m]||(b=h=0)||d.pop())&&((a?p.nodeName.toLowerCase()!==v:1!==p.nodeType)||!++b||(y&&(f=p[F]||(p[F]={}),c=f[p.uniqueID]||(f[p.uniqueID]={}),c[e]=[B,b]),p!==t)););return(b-=i)===r||b%r==0&&b/r>=0}}},PSEUDO:function(e,n){var i,o=w.pseudos[e]||w.setFilters[e.toLowerCase()]||t.error("unsupported pseudo: "+e)
return o[F]?o(n):o.length>1?(i=[e,e,"",n],w.setFilters.hasOwnProperty(e.toLowerCase())?r(function(e,t){for(var r,i=o(e,n),s=i.length;s--;)r=J(e,i[s]),e[r]=!(t[r]=i[s])}):function(e){return o(e,0,i)}):o}},pseudos:{not:r(function(e){var t=[],n=[],i=x(e.replace(oe,"$1"))
...
if(!o){for(t||(t=T(e)),n=t.length;n--;)o=v(t[n]),o[F]?r.push(o):i.push(o)
o=W(e,y(i,r)),o.selector=e}return o},O=t.select=function(e,t,n,r){var i,o,s,a,u,c="function"==typeof e&&e,p=!r&&T(e=c.selector||e)
if(n=n||[],1===p.length){if(o=p[0]=p[0].slice(0),o.length>2&&"ID"===(s=o[0]).type&&9===t.nodeType&&D&&w.relative[o[1].type]){if(!(t=(w.find.ID(s.matches[0].replace(ve,ye),t)||[])[0]))return n
...
return n},Ee=de.expr.match.needsContext,Ce=/^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i,Te=/^.[^:#\[\.,]*$/
...
var xe,Oe=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(de.fn.init=function(e,t,n){var r,i
if(!e)return this
if(n=n||xe,"string"==typeof e){if(!(r="<"===e[0]&&">"===e[e.length-1]&&e.length>=3?[null,e,null]:Oe.exec(e))||!r[1]&&t)return!t||t.jquery?(t||n).find(e):this.constructor(t).find(e)
if(r[1]){if(t=t instanceof de?t[0]:t,de.merge(this,de.parseHTML(r[1],t&&t.nodeType?t.ownerDocument||t:ne,!0)),Ce.test(r[1])&&de.isPlainObject(t))for(r in t)de.isFunction(this[r])?this[r](t[r]):this.attr(r,t[r])
return this}return i=ne.getElementById(r[2]),i&&(this[0]=i,this.length=1),this}return e.nodeType?(this[0]=e,this.length=1,this):de.isFunction(e)?void 0!==n.ready?n.ready(e):e(de):de.makeArray(e,this)}).prototype=de.fn,xe=de(ne)
...
var Ie=new p,je=new p,Le=/^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,Me=/[A-Z]/g
de.extend({hasData:function(e){return je.hasData(e)||Ie.hasData(e)},data:function(e,t,n){return je.access(e,t,n)},removeData:function(e,t){je.remove(e,t)},_data:function(e,t,n){return Ie.access(e,t,n)},_removeData:function(e,t){Ie.remove(e,t)}}),de.fn.extend({data:function(e,t){var n,r,i,o=this[0],s=o&&o.attributes
if(void 0===e){if(this.length&&(i=je.get(o),1===o.nodeType&&!Ie.get(o,"hasDataAttrs"))){for(n=s.length;n--;)s[n]&&(r=s[n].name,0===r.indexOf("data-")&&(r=de.camelCase(r.slice(5)),d(o,r,i[r])))
Ie.set(o,"hasDataAttrs",!0)}return i}return"object"==typeof e?this.each(function(){je.set(this,e)}):Ne(this,function(t){var n
...
if(e)return t=(t||"fx")+"queue",r=Ie.get(e,t),n&&(!r||Array.isArray(n)?r=Ie.access(e,t,de.makeArray(n)):r.push(n)),r||[]},dequeue:function(e,t){t=t||"fx"
...
return Ie.get(e,n)||Ie.access(e,n,{empty:de.Callbacks("once memory").add(function(){Ie.remove(e,[t+"queue",n])})})}}),de.fn.extend({queue:function(e,t){var n=2
...
var Fe=/[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,He=new RegExp("^(?:([+-])=|)("+Fe+")([a-z%]*)$","i"),Be=["Top","Right","Bottom","Left"],Ue=function(e,t){return e=t||e,"none"===e.style.display||""===e.style.display&&de.contains(e.ownerDocument,e)&&"none"===de.css(e,"display")},ze=function(e,t,n,r){var i,o,s={}
...
de.event={global:{},add:function(e,t,n,r,i){var o,s,a,u,l,c,f,p,h,d,m,g=Ie.get(e)
if(g)for(n.handler&&(o=n,n=o.handler,i=o.selector),i&&de.find.matchesSelector(Qe,i),n.guid||(n.guid=de.guid++),(u=g.events)||(u=g.events={}),(s=g.handle)||(s=g.handle=function(t){return void 0!==de&&de.event.triggered!==t.type?de.event.dispatch.apply(e,arguments):void 0}),t=(t||"").match(ke)||[""],l=t.length;l--;)a=Je.exec(t[l])||[],h=m=a[1],d=(a[2]||"").split(".").sort(),h&&(f=de.event.special[h]||{},h=(i?f.delegateType:f.bindType)||h,f=de.event.special[h]||{},c=de.extend({type:h,origType:m,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&de.expr.match.needsContext.test(i),namespace:d.join(".")},o),(p=u[h])||(p=u[h]=[],p.delegateCount=0,f.setup&&!1!==f.setup.call(e,r,d,s)||e.addEventListener&&e.addEventListener(h,s)),f.add&&(f.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),i?p.splice(p.delegateCount++,0,c):p.push(c),de.event.global[h]=!0)},remove:function(e,t,n,r,i){var o,s,a,u,l,c,f,p,h,d,m,g=Ie.hasData(e)&&Ie.get(e)
if(g&&(u=g.events)){for(t=(t||"").match(ke)||[""],l=t.length;l--;)if(a=Je.exec(t[l])||[],h=m=a[1],d=(a[2]||"").split(".").sort(),h){for(f=de.event.special[h]||{},h=(r?f.delegateType:f.bindType)||h,p=u[h]||[],a=a[2]&&new RegExp("(^|\\.)"+d.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=o=p.length;o--;)c=p[o],!i&&m!==c.origType||n&&n.guid!==c.guid||a&&!a.test(c.namespace)||r&&r!==c.selector&&("**"!==r||!c.selector)||(p.splice(o,1),c.selector&&p.delegateCount--,f.remove&&f.remove.call(e,c))
...
de.isEmptyObject(u)&&Ie.remove(e,"handle events")}},dispatch:function(e){var t,n,r,i,o,s,a=de.event.fix(e),u=new Array(arguments.length),l=(Ie.get(this,"events")||{})[a.type]||[],c=de.event.special[a.type]||{}
...
return i&&(i===r||de.contains(r,i))||(e.type=o.origType,n=o.handler.apply(this,arguments),e.type=t),n}}}),de.fn.extend({on:function(e,t,n,r){return T(this,e,t,n,r)},one:function(e,t,n,r){return T(this,e,t,n,r,1)},off:function(e,t,n){var r,i
...
return s=y(a,"script"),s.length>0&&b(s,!u&&y(e,"script")),a},cleanData:function(e){for(var t,n,r,i=de.event.special,o=0;void 0!==(n=e[o]);o++)if(De(n)){if(t=n[Ie.expando]){if(t.events)for(r in t.events)i[r]?de.event.remove(n,r):de.removeEvent(n,r,t.handle)
n[Ie.expando]=void 0}n[je.expando]&&(n[je.expando]=void 0)}}}),de.fn.extend({detach:function(e){return P(this,e,!0)},remove:function(e){return P(this,e)},text:function(e){return Ne(this,function(e){return void 0===e?de.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return R(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){x(this,e).appendChild(e)}})},prepend:function(){return R(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=x(this,e)
...
if(u||(t=j(a)),s=de.cssHooks[t]||de.cssHooks[a],void 0===n)return s&&"get"in s&&void 0!==(i=s.get(e,!1,r))?i:l[t]
...
return m(n.elem,e,He.exec(t),n),n}]},tweener:function(e,t){de.isFunction(e)?(t=e,e=["*"]):e=e.match(ke)
...
return de.fx.off?r.duration=0:"number"!=typeof r.duration&&(r.duration in de.fx.speeds?r.duration=de.fx.speeds[r.duration]:r.duration=de.fx.speeds._default),null!=r.queue&&!0!==r.queue||(r.queue="fx"),r.old=r.complete,r.complete=function(){de.isFunction(r.old)&&r.old.call(this),r.queue&&de.dequeue(this,r.queue)},r},de.fn.extend({fadeTo:function(e,t,n,r){return this.filter(Ue).css("opacity",0).show().end().animate({opacity:t},e,n,r)},animate:function(e,t,n,r){var i=de.isEmptyObject(e),o=de.speed(t,n,r),s=function(){var t=K(this,de.extend({},e),o);(i||Ie.get(this,"finish"))&&t.stop(!0)}
return s.finish=s,i||!1===o.queue?this.each(s):this.queue(o.queue,s)},stop:function(e,t,n){var r=function(e){var t=e.stop
delete e.stop,t(n)}
return"string"!=typeof e&&(n=t,t=e,e=void 0),t&&!1!==e&&this.queue(e||"fx",[]),this.each(function(){var t=!0,i=null!=e&&e+"queueHooks",o=de.timers,s=Ie.get(this)
if(i)s[i]&&s[i].stop&&r(s[i])
else for(i in s)s[i]&&s[i].stop&&gt.test(i)&&r(s[i])
for(i=o.length;i--;)o[i].elem!==this||null!=e&&o[i].queue!==e||(o[i].anim.stop(n),t=!1,o.splice(i,1))
!t&&n||de.dequeue(this,e)})},finish:function(e){return!1!==e&&(e=e||"fx"),this.each(function(){var t,n=Ie.get(this),r=n[e+"queue"],i=n[e+"queueHooks"],o=de.timers,s=r?r.length:0
...
return"boolean"==typeof t&&"string"===n?t?this.addClass(e):this.removeClass(e):de.isFunction(e)?this.each(function(n){de(this).toggleClass(e.call(this,n,$(this),t),t)}):this.each(function(){var t,r,i,o
if("string"===n)for(r=0,i=de(this),o=e.match(ke)||[];t=o[r++];)i.hasClass(t)?i.removeClass(t):i.addClass(t)
else void 0!==e&&"boolean"!==n||(t=$(this),t&&Ie.set(this,"__className__",t),this.setAttribute&&this.setAttribute("class",t||!1===e?"":Ie.get(this,"__className__")||""))})},hasClass:function(e){var t,n,r=0
...
a===(r.ownerDocument||ne)&&p.push(a.defaultView||a.parentWindow||e)}for(o=0;(s=p[o++])&&!t.isPropagationStopped();)t.type=o>1?u:f.bindType||h,c=(Ie.get(s,"events")||{})[t.type]&&Ie.get(s,"handle"),c&&c.apply(s,n),(c=l&&s[l])&&c.apply&&De(s)&&(t.result=c.apply(s,n),!1===t.result&&t.preventDefault())
...
de.event.special[t]={setup:function(){var r=this.ownerDocument||this,i=Ie.access(r,t)
...
var Ct=e.location,Tt=de.now(),xt=/\?/
...
return this.name&&!de(this).is(":disabled")&&kt.test(this.nodeName)&&!At.test(e)&&(this.checked||!We.test(e))}).map(function(e,t){var n=de(this).val()
return null==n?null:Array.isArray(n)?de.map(n,function(e){return{name:t.name,value:e.replace(St,"\r\n")}}):{name:t.name,value:n.replace(St,"\r\n")}}).get()}})
var Rt=/%20/g,Pt=/#.*$/,Nt=/([?&])_=[^&]*/,Dt=/^(.*?):[ \t]*([^\r\n]*)$/gm,It=/^(?:about|app|app-storage|.+-extension|file|res|widget):$/,jt=/^(?:GET|HEAD)$/,Lt=/^\/\//,Mt={},Ft={},Ht="*/".concat("*"),Bt=ne.createElement("a")
Bt.href=Ct.href,de.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:Ct.href,type:"GET",isLocal:It.test(Ct.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":Ht,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":de.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?J(J(e,de.ajaxSettings),t):J(de.ajaxSettings,e)},ajaxPrefilter:Y(Mt),ajaxTransport:Y(Ft),ajax:function(t,n){function r(t,n,r,a){var l,p,h,_,w,E=n
c||(c=!0,u&&e.clearTimeout(u),i=void 0,s=a||"",C.readyState=t>0?4:0,l=t>=200&&t<300||304===t,r&&(_=Z(d,C,r)),_=ee(d,_,C,l),l?(d.ifModified&&(w=C.getResponseHeader("Last-Modified"),w&&(de.lastModified[o]=w),(w=C.getResponseHeader("etag"))&&(de.etag[o]=w)),204===t||"HEAD"===d.type?E="nocontent":304===t?E="notmodified":(E=_.state,p=_.data,h=_.error,l=!h)):(h=E,!t&&E||(E="error",t<0&&(t=0))),C.status=t,C.statusText=(n||E)+"",l?v.resolveWith(m,[p,E,C]):v.rejectWith(m,[C,E,h]),C.statusCode(b),b=void 0,f&&g.trigger(l?"ajaxSuccess":"ajaxError",[C,d,l?p:h]),y.fireWith(m,[C,E]),f&&(g.trigger("ajaxComplete",[C,d]),--de.active||de.event.trigger("ajaxStop")))}"object"==typeof t&&(n=t,t=void 0),n=n||{}
var i,o,s,a,u,l,c,f,p,h,d=de.ajaxSetup({},n),m=d.context||d,g=d.context&&(m.nodeType||m.jquery)?de(m):de.event,v=de.Deferred(),y=de.Callbacks("once memory"),b=d.statusCode||{},_={},w={},E="canceled",C={readyState:0,getResponseHeader:function(e){var t
...
if(v.promise(C),d.url=((t||d.url||Ct.href)+"").replace(Lt,Ct.protocol+"//"),d.type=n.method||n.type||d.method||d.type,d.dataTypes=(d.dataType||"*").toLowerCase().match(ke)||[""],null==d.crossDomain){l=ne.createElement("a")
try{l.href=d.url,l.href=l.href,d.crossDomain=Bt.protocol+"//"+Bt.host!=l.protocol+"//"+l.host}catch(e){d.crossDomain=!0}}if(d.data&&d.processData&&"string"!=typeof d.data&&(d.data=de.param(d.data,d.traditional)),X(Mt,d,n,C),c)return C
f=de.event&&d.global,f&&0==de.active++&&de.event.trigger("ajaxStart"),d.type=d.type.toUpperCase(),d.hasContent=!jt.test(d.type),o=d.url.replace(Pt,""),d.hasContent?d.data&&d.processData&&0===(d.contentType||"").indexOf("application/x-www-form-urlencoded")&&(d.data=d.data.replace(Rt,"+")):(h=d.url.slice(o.length),d.data&&(o+=(xt.test(o)?"&":"?")+d.data,delete d.data),!1===d.cache&&(o=o.replace(Nt,"$1"),h=(xt.test(o)?"&":"?")+"_="+Tt+++h),d.url=o+h),d.ifModified&&(de.lastModified[o]&&C.setRequestHeader("If-Modified-Since",de.lastModified[o]),de.etag[o]&&C.setRequestHeader("If-None-Match",de.etag[o])),(d.data&&d.hasContent&&!1!==d.contentType||n.contentType)&&C.setRequestHeader("Content-Type",d.contentType),C.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+Ht+"; q=0.01":""):d.accepts["*"])
for(p in d.headers)C.setRequestHeader(p,d.headers[p])
if(d.beforeSend&&(!1===d.beforeSend.call(m,C,d)||c))return C.abort()
if(E="abort",y.add(d.complete),C.done(d.success),C.fail(d.error),i=X(Ft,d,n,C)){if(C.readyState=1,f&&g.trigger("ajaxSend",[C,d]),c)return C
...
var qt=[],Wt=/(=)\?(?=&|$)|\?\?/
de.ajaxSetup({jsonp:"callback",jsonpCallback:function(){var e=qt.pop()||de.expando+"_"+Tt++
...
if(a||"jsonp"===t.dataTypes[0])return i=t.jsonpCallback=de.isFunction(t.jsonpCallback)?t.jsonpCallback():t.jsonpCallback,a?t[a]=t[a].replace(Wt,"$1"+i):!1!==t.jsonp&&(t.url+=(xt.test(t.url)?"&":"?")+t.jsonp+"="+i),t.converters["script json"]=function(){return s||de.error(i+" was not called"),s[0]},t.dataTypes[0]="json",o=e[i],e[i]=function(){s=arguments},r.always(function(){void 0===o?de(e).removeProp(i):e[i]=o,t[i]&&(t.jsonpCallback=n.jsonpCallback,qt.push(i)),s&&de.isFunction(o)&&o(s[0]),s=o=void 0}),"script"}),he.createHTMLDocument=function(){var e=ne.implementation.createHTMLDocument("").body
return e.innerHTML="<form></form><form></form>",2===e.childNodes.length}(),de.parseHTML=function(e,t,n){if("string"!=typeof e)return[]
"boolean"==typeof t&&(n=t,t=!1)
var r,i,o
return t||(he.createHTMLDocument?(t=ne.implementation.createHTMLDocument(""),r=t.createElement("base"),r.href=ne.location.href,t.head.appendChild(r)):t=ne),i=Ce.exec(e),o=!n&&[],i?[t.createElement(i[1])]:(i=_([e],t,o),o&&o.length&&de(o).remove(),de.merge([],i.childNodes))},de.fn.load=function(e,t,n){var r,i,o,s=this,a=e.indexOf(" ")
...
return de.noConflict=function(t){return e.$===de&&(e.$=Kt),t&&e.jQuery===de&&(e.jQuery=Vt),de},t||(e.jQuery=e.$=de),de}),function(){var e,t,n,r=this;(function(){function r(e,t){throw t?new Error("Could not find module "+e+" required by: "+t):new Error("Could not find module "+e)}function i(e,n){var a=e,u=o[a]
u||(a+="/index",u=o[a])
var l=s[a]
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function P(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):A(e,t))}function N(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function D(e,t){return new vn(e,t)}function I(e,t){for(var n,r=e.parentElement(),i=e.firstNode(),o=e.lastNode(),s=i;s;){if(n=s.nextSibling,r.insertBefore(s,t),s===o)return n
...
return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function F(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t)
e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):L(e,t))}function H(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function B(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function U(e){return"object"==typeof e&&null!==e&&e[On]}function z(e,t){var n,r,i,o=Object.getOwnPropertyNames(t)
for(n=0;n<o.length;n++)r=o[n],(i=Object.getOwnPropertyDescriptor(t,r))&&i.configurable&&void 0===e[r]&&Object.defineProperty(e,r,i)
...
throw(0,t.unreachable)()}function Y(e,n,r){if($(r))return kn.insert(e,n,r)
if(G(r))return Pn.insert(e,n,r)
...
t?(o=t[0],s=t[1],_e(s,i),i.pushDynamicScope(),i.bindDynamicScope(o),i.invokeStatic(n),i.popDynamicScope()):i.invokeStatic(n)}),{blocks:e,inlines:t}}function Ee(e,t){sr.compile(e,t)}function Ce(e,t,n){var r,i=new nr(n,t)
...
i.push([yr.ClientSideStatement,zn.OpenComponentElement,e]),i.push([yr.ClientSideStatement,zn.DidCreateElement]),i.push([yr.Yield,o,t.EMPTY_ARRAY]),i.push.apply(i,r)}function Ae(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function ke(e,t){return-1!==e.indexOf(t)}function Re(e,t){return(null===e||ke(Er,e))&&ke(Tr,t)}function Pe(e,t){return null!==e&&(ke(Cr,e)&&ke(xr,t))}function Ne(e,t){return Re(e,t)||Pe(e,t)}function De(e,t,n,r){var i,o=null
if(null===r||void 0===r)return r
if(K(r))return r.toHTML()
o=t?t.tagName.toUpperCase():null
var s=ne(r)
return Re(o,n)&&(i=e.protocolForURL(s),ke(wr,i))?"unsafe:"+s:Pe(o,n)?"unsafe:"+s:s}function Ie(e,t){var n,r=void 0,i=void 0
return t in e?(i=t,r="prop"):(n=t.toLowerCase(),n in e?(r="prop",i=n):(r="attr",i=t)),"prop"!==r||"style"!==i.toLowerCase()&&!je(e.tagName,i)||(r="attr"),{normalized:i,type:r}}function je(e,t){var n=Or[e.toUpperCase()]
...
var Pt=function(){function e(){a(this,e),this.evaluateOpcode=(0,t.fillNulls)(72).slice()}return e.prototype.add=function(e,t){this.evaluateOpcode[e]=t},e.prototype.evaluate=function(e,t,n){(0,this.evaluateOpcode[n])(e,t)},e}(),Nt=new Pt,Dt=function(){function e(){a(this,e),(0,t.initializeGuid)(this)}return e.prototype.toJSON=function(){return{guid:this._guid,type:this.type}},e}(),It=function(e){function t(){a(this,t)
var n=o(this,e.apply(this,arguments))
return n.next=null,n.prev=null,n}return s(t,e),t}(Dt),jt=function(e){function t(n){return l(this,t),c(this,e.call(this,n))}return f(t,e),t.create=function(e){return void 0===e?Ft:null===e?Ht:!0===e?Bt:!1===e?Ut:"number"==typeof e?new Mt(e):new Lt(e)},t.prototype.get=function(){return Ft},t}(n.ConstReference),Lt=function(e){function t(){l(this,t)
var n=c(this,e.apply(this,arguments))
return n.lengthReference=null,n}return f(t,e),t.prototype.get=function(t){var n
return"length"===t?(n=this.lengthReference,null===n&&(n=this.lengthReference=new Mt(this.inner.length)),n):e.prototype.get.call(this,t)},t}(jt),Mt=function(e){function t(n){return l(this,t),c(this,e.call(this,n))}return f(t,e),t}(jt),Ft=new Mt(void 0),Ht=new Mt(null),Bt=new Mt(!0),Ut=new Mt(!1),zt=function(){function e(t){l(this,e),this.inner=t,this.tag=t.tag}return e.prototype.value=function(){return this.toBool(this.inner.value())},e.prototype.toBool=function(e){return!!e},e}(),qt=function(e){function t(r){h(this,t)
...
for(n=0;n<t.length;n++)r=t[n],r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),Vt=function(){function e(){v(this,e),this.stack=null,this.positional=new Kt,this.named=new $t}return e.prototype.empty=function(){return this.setup(null,!0),this},e.prototype.setup=function(e,t){this.stack=e
...
return e<0||e>=n?Ft:this.stack.fromTop(t-e-1)},e.prototype.capture=function(){return new Gt(this.tag,this.references)},Wt(e,[{key:"tag",get:function(){var e=this._tag
...
return"length"===e?jt.create(r):(t=parseInt(e,10),t<0||t>=r?Ft:n[t])},e.prototype.valueOf=function(e){return e.value()},e}(),$t=function(){function e(){v(this,e),this.length=0,this._tag=null,this._references=null,this._names=null,this._realNames=t.EMPTY_ARRAY}return e.prototype.setup=function(e,n,r,i){this.stack=e,this.length=n,this._tag=null,this._references=null,i?(this._names=r,this._realNames=t.EMPTY_ARRAY):(this._names=null,this._realNames=r)},e.prototype.has=function(e){return-1!==this.names.indexOf(e)},e.prototype.get=function(e){var t=this.names,n=this.length,r=t.indexOf(e)
...
try{r=JSON.stringify(n.peek())}catch(e){r=String(n.peek())}return{args:[],details:{expected:r},guid:t,type:e}},t}(It),tn=function(e){function t(n,r){b(this,t)
...
!e.alwaysRevalidate&&t.validate(r)&&e.goto(n)},t.prototype.didModify=function(){this.lastRevision=this.tag.value()},t.prototype.toJSON=function(){return{args:[JSON.stringify(this.target.inspect())],guid:this._guid,type:this.type}},t}(It),nn=function(e){function t(r){b(this,t)
var i=_(this,e.call(this))
...
return e?t?jt.create(O(e)):new sn(e):Ht},e}(),sn=function(e){function t(r){x(this,t)
var i=C(this,e.call(this))
return i.list=[],i.tag=(0,n.combineTagged)(r),i.list=r,i}return T(t,e),t.prototype.compute=function(){return O(this.list)},t}(n.CachedReference),an=function(){function e(t){x(this,e),this.env=t,this.opcodes=null,this.classList=null}return e.prototype.addStaticAttribute=function(e,t,n){"class"===t?this.addClass(jt.create(n)):this.env.getAppendOperations().setAttribute(e,t,n)},e.prototype.addStaticAttributeNS=function(e,t,n,r){this.env.getAppendOperations().setAttribute(e,n,r,t)},e.prototype.addDynamicAttribute=function(e,t,n,r){var i,o
...
p&&e.newDestroyable(p),e.updateWith(new ln(s,r,f))})
...
var pn=function(e){function t(n){x(this,t)
...
Yt.setup(r,!!n),r.push(Yt)}),Nt.add(59,function(e,t){var n,r,i,o,s,a,u,l,c,f,p=t.op1,h=e.stack,d=e.fetchValue(p),m=d.definition,g=d.manager,v=h.pop(),y=g.prepareArgs(m,v)
if(y){for(v.clear(),n=y.positional,r=y.named,i=n.length,o=0;o<i;o++)h.push(n[o])
for(h.push(i),s=Object.keys(r),a=s.length,u=[],l=0;l<a;l++)c=r[s[l]],f="@"+s[l],h.push(c),u.push(f)
...
t.update(e,n)},t.prototype.toJSON=function(){return{args:[JSON.stringify(this.name)],guid:this._guid,type:this.type}},t}(It),dn=function(e){function t(r,i,o){k(this,t)
var s=R(this,e.call(this))
...
if(t&&t.length)for(e=0;e<t.length;e++)t[e].destroy()},e.prototype.parentElement=function(){return this.parent},e.prototype.firstNode=function(){return this.first&&this.first.firstNode()},e.prototype.lastNode=function(){return this.last&&this.last.lastNode()},e.prototype.openElement=function(e){this.newNode(e),this.nesting++},e.prototype.closeElement=function(){this.nesting--},e.prototype.newNode=function(e){0===this.nesting&&(this.first||(this.first=new yn(e)),this.last=new bn(e))},e.prototype.newBounds=function(e){0===this.nesting&&(this.first||(this.first=e),this.last=e)},e.prototype.newDestroyable=function(e){this.destroyables=this.destroyables||[],this.destroyables.push(e)},e.prototype.finalize=function(e){this.first||e.appendComment("")},e}(),Cn=function(e){function t(){return H(this,t),M(this,e.apply(this,arguments))}return F(t,e),t.prototype.destroy=function(){e.prototype.destroy.call(this),j(this)},t}(En),Tn=function(e){function t(){return H(this,t),M(this,e.apply(this,arguments))}return F(t,e),t.prototype.reset=function(e){var t,n=this.destroyables
...
return!!$(t)&&(n=this.textNode,n.nodeValue=t,!0)},t}(Sn),kn=function(e){function t(){return V(this,t),q(this,e.apply(this,arguments))}return W(t,e),t.insert=function(e,n,r){return new t(e.insertHTMLBefore(n.element,n.nextSibling,r))},t.prototype.update=function(e,t){var n,r,i
return!!$(t)&&(n=this.bounds,r=n.parentElement(),i=j(n),this.bounds=e.insertHTMLBefore(r,i,t),!0)},t}(Sn),Rn=function(e){function t(n,r){V(this,t)
var i=q(this,e.call(this,n))
return i.lastStringValue=r,i}return W(t,e),t.insert=function(e,n,r){var i=r.toHTML()
return new t(e.insertHTMLBefore(n.element,n.nextSibling,i),i)},t.prototype.update=function(e,t){var n,r,i,o
return!!K(t)&&(n=t.toHTML(),n!==this.lastStringValue&&(r=this.bounds,i=r.parentElement(),o=j(r),this.bounds=e.insertHTMLBefore(i,o,n),this.lastStringValue=n),!0)},t}(Sn),Pn=function(e){function t(){return V(this,t),q(this,e.apply(this,arguments))}return W(t,e),t.insert=function(e,n,r){return e.insertBefore(n.element,r,n.nextSibling),new t(D(n.element,r))},t.prototype.update=function(e,t){var n,r,i
return!!G(t)&&(n=this.bounds,r=n.parentElement(),i=j(n),this.bounds=e.insertNodeBefore(r,t,i),!0)},t}(Sn)
...
s.newBounds(u),o&&e.updateWith(this.updateWith(e,t,o,u,a))},e}(),Dn=function(e){function t(){return ee(this,t),J(this,e.apply(this,arguments))}return Z(t,e),t.create=function(e){return new t(e)},t.prototype.toBool=function(e){return U(e)},t}(zt),In=function(e){function t(n,r,i){ee(this,t)
var o=J(this,e.call(this))
return o.cache=n,o.bounds=r,o.upsert=i,o.tag=n.tag,o}return Z(t,e),t.prototype.evaluate=function(e){var t,r,i,o,s=this.cache.revalidate();(0,n.isModified)(s)&&(t=this.bounds,r=this.upsert,i=e.dom,this.upsert.update(i,s)||(o=new mn(t.parentElement(),j(t)),r=this.upsert=this.insert(e.env.getAppendOperations(),o,s)),t.update(r.bounds))},t.prototype.toJSON=function(){var e=this._guid,t=this.type,n=this.cache
return{details:{lastValue:JSON.stringify(n.peek())},guid:e,type:t}},t}(It),jn=function(e){function t(){ee(this,t)
...
var n=J(this,e.apply(this,arguments))
return n.type="optimized-cautious-update",n}return Z(t,e),t.prototype.insert=function(e,t,n){return Q(e,t,n)},t}(In),Mn=function(e){function t(){ee(this,t)
var n=J(this,e.apply(this,arguments))
...
var n=J(this,e.apply(this,arguments))
return n.type="optimized-trusting-update",n}return Z(t,e),t.prototype.insert=function(e,t,n){return Y(e,t,n)},t}(In),Hn=se,Bn=function(){function e(n,r,i){var o,s,a,u
...
for(n=0;n<t.length;n++)r=t[n],r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),Kn=function(){function e(t){le(this,e),this.env=t}return e.prototype.wrapLayout=function(e){this.inner=new Gn(this.env,e)},e.prototype.fromLayout=function(e,t){this.inner=new $n(this.env,e,t)},e.prototype.compile=function(){return this.inner.compile()},Vn(e,[{key:"tag",get:function(){return this.inner.tag}},{key:"attrs",get:function(){return this.inner.attrs}}]),e}(),Gn=function(){function e(t,n){le(this,e),this.env=t,this.layout=n,this.tag=new Qn,this.attrs=new Yn}return e.prototype.compile=function(){var e,t,n=this.env,r=this.layout,i={templateMeta:r.meta,symbols:r.symbols,asPartial:!1},o=this.tag.getDynamic(),s=this.tag.getStatic(),a=ce(n,i)
...
var u=a.start
return a.finalize(),new Wn(u,{meta:i,hasEval:r.hasEval,symbols:r.symbols.concat([ir])})},e}(),$n=function(){function e(t,n,r){le(this,e),this.env=t,this.componentName=n,this.layout=r,this.attrs=new Yn}return e.prototype.compile=function(){var e=this.env
return this.layout.asLayout(this.componentName,this.attrs.buffer).compileDynamic(e)},Vn(e,[{key:"tag",get:function(){throw new Error("BUG: Cannot call `tag` on an UnwrappedBuilder")}}]),e}(),Qn=function(){function e(){le(this,e),this.isDynamic=null,this.isStatic=null,this.staticTagName=null,this.dynamicTagName=null}return e.prototype.getDynamic=function(){if(this.isDynamic)return this.dynamicTagName},e.prototype.getStatic=function(){if(this.isStatic)return this.staticTagName},e.prototype.static=function(e){this.isStatic=!0,this.staticTagName=e},e.prototype.dynamic=function(e){this.isDynamic=!0,this.dynamicTagName=[r.Ops.ClientSideExpression,zn.FunctionExpression,e]},e}(),Yn=function(){function e(){le(this,e),this.buffer=[]}return e.prototype.static=function(e,t){this.buffer.push([r.Ops.StaticAttr,e,t,null])},e.prototype.dynamic=function(e,t){this.buffer.push([r.Ops.DynamicAttr,e,[r.Ops.ClientSideExpression,zn.FunctionExpression,t],null])},e}(),Xn=function(){function e(t){le(this,e),this.builder=t,this.env=t.env}return e.prototype.static=function(e,t){var n=t[0],r=t[1],i=t[2],o=t[3],s=this.builder
...
sr.add(rr.Component,function(e,n){var r,i,o,s,a,u,l=e[1],c=e[2],f=e[3],p=e[4]
...
n.closeElement()}})
var lr=function(){function e(t,n){ve(this,e),this.outerSymbols=t,this.evalInfo=n}return e.prototype.invoke=function(e,n){var r,i,o,s,a,u,l,c,f=n,p=f.symbolTable.symbols,h=e.scope(),d=e.pushRootScope(p.length,!1)
...
for(a=0;a<p.length;a++)u=p[a],l=a+1,void 0!==(c=y[u])&&d.bind(l,c)
...
we(mr,new gr)
var vr=function(){function e(t,n){Te(this,e),this.statements=t,this.symbolTable=n,this.compiledStatic=null,this.compiledDynamic=null}return e.prototype.compileStatic=function(e){var t,n,r=this.compiledStatic
return r||(t=Ce(this.statements,this.symbolTable.meta,e),t.finalize(),n=t.start,r=this.compiledStatic=new qn(n)),r},e.prototype.compileDynamic=function(e){var t,n=this.compiledDynamic
return n||(t=this.compileStatic(e),n=new Wn(t.handle,this.symbolTable)),n},e}(),yr=r.Ops,br=function(){function e(t,n){xe(this,e),this.block=t,this.env=n}return e.prototype.scanEntryPoint=function(e){var t=this.block,n=t.statements,r=t.symbols,i=t.hasEval
return new vr(n,{meta:e,symbols:r,hasEval:i})},e.prototype.scanBlock=function(e){var n=this.block,r=n.statements
return new vr(r,{meta:e,parameters:t.EMPTY_ARRAY})},e.prototype.scanLayout=function(e,t,n){var i,o,s,a=this.block,u=a.statements,l=a.symbols,c=a.hasEval,f=[],p=void 0,h=!1
for(i=0;i<u.length;i++)if(o=u[i],r.Statements.isComponent(o))s=o[1],this.env.hasComponentDefinition(s,e.templateMeta)?void 0===p&&s===n?(p=s,Se(s,l,t,f),Oe(o,f)):f.push(o):(void 0!==p?f.push([yr.OpenElement,s]):(p=s,Se(s,l,t,f)),Oe(o,f))
else if(void 0===p&&r.Statements.isOpenElement(o))p=o[1],h=!0,Se(p,l,t,f)
else{if(h)if(r.Statements.isFlushElement(o))h=!1
else if(r.Statements.isModifier(o))throw Error('Found modifier "'+o[1]+'" on the top-level element of "'+n+'". Modifiers cannot be on the top-level element')
f.push(o)}return f.push([yr.ClientSideStatement,zn.DidRenderLayout]),new vr(f,{meta:e,hasEval:c,symbols:l})},e}(),_r=function(){function e(){Ae(this,e),this.references=[],this.strings=[],this.expressions=[],this.floats=[],this.arrays=[],this.blocks=[],this.functions=[],this.others=[]}return e.prototype.getReference=function(e){return this.references[e-1]},e.prototype.reference=function(e){var t=this.references.length
...
var n=t
n=et(Dr,n),n=Be(Dr,n),n=Ge(Dr,n,Ar),e.DOMTreeConstruction=n})(Pr||(Pr={}))
...
return this.insertBefore(e,r,t),r},t.prototype.insertBefore=function(e,t,n){e.insertBefore(t,n)},t.prototype.insertAfter=function(e,t,n){this.insertBefore(e,t,n.nextSibling)},t}(Ir),Lr=jr
...
return function(e){function t(){return Me(this,t),Fe(this,e.apply(this,arguments))}return He(t,e),t.prototype.insertHTMLBefore=function(t,r,i){if(null===i||""===i)return e.prototype.insertHTMLBefore.call(this,t,r,i)
var o=t.tagName.toLowerCase(),s=Sr[o]
return void 0===s?e.prototype.insertHTMLBefore.call(this,t,r,i):Ue(t,s,n,i,r)},t}(t)}(Dr,Lr),Lr=function(e,t,n){if(!e)return t
if(!Qe(e,n))return t
var r=e.createElement("div")
return function(e){function t(){return We(this,t),Ve(this,e.apply(this,arguments))}return Ke(t,e),t.prototype.insertHTMLBefore=function(t,i,o){return null===o||""===o?e.prototype.insertHTMLBefore.call(this,t,i,o):t.namespaceURI!==n?e.prototype.insertHTMLBefore.call(this,t,i,o):$e(t,r,o,i)},t}(t)}(Dr,Lr,Ar)
var Mr,Fr=Lr,Hr=Pr.DOMTreeConstruction,Br=function(){function e(t){pt(this,e),this.attr=t}return e.prototype.setAttribute=function(e,t,n,r){var i=e.getAppendOperations(),o=gt(n)
vt(o)||i.setAttribute(t,this.attr,o,r)},e.prototype.updateAttribute=function(e,t,n,r){null===n||void 0===n||!1===n?r?e.getDOM().removeAttributeNS(t,r,this.attr):e.getDOM().removeAttribute(t,this.attr):this.setAttribute(e,t,n)},e}(),Ur=function(e){function t(){return pt(this,t),ct(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(e,t,n){vt(n)||(t[this.attr]=n)},t.prototype.removeAttribute=function(e,t,n){var r=this.attr
n?e.getDOM().removeAttributeNS(t,n,r):e.getDOM().removeAttribute(t,r)},t.prototype.updateAttribute=function(e,t,n,r){t[this.attr]=n,vt(n)&&this.removeAttribute(e,t,r)},t}(Br),zr=function(e){function t(){return pt(this,t),ct(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(t,n,r){e.prototype.setAttribute.call(this,t,n,De(t,n,this.attr,r))},t.prototype.updateAttribute=function(t,n,r){e.prototype.updateAttribute.call(this,t,n,De(t,n,this.attr,r))},t}(Ur),qr=function(e){function t(){return pt(this,t),ct(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(e,t,n){t.value=ne(n)},t.prototype.updateAttribute=function(e,t,n){var r=t,i=r.value,o=ne(n)
i!==o&&(r.value=o)},t}(Br),Wr=new qr("value"),Vr=function(e){function t(){return pt(this,t),ct(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(e,t,n){null!==n&&void 0!==n&&!1!==n&&(t.selected=!0)},t.prototype.updateAttribute=function(e,t,n){var r=t
r.selected=!!n},t}(Ur),Kr=new Vr("selected"),Gr=function(e){function t(){return pt(this,t),ct(this,e.apply(this,arguments))}return ft(t,e),t.prototype.setAttribute=function(t,n,r){e.prototype.setAttribute.call(this,t,n,De(t,n,this.attr,r))},t.prototype.updateAttribute=function(t,n,r){e.prototype.updateAttribute.call(this,t,n,De(t,n,this.attr,r))},t}(Br),$r=function(){function e(e,t){var n,r
...
for(c=0;c<_.length;c++)f=_[c],p=w[c],f.update(p)},e}(),Xr=function(){function e(t){_t(this,e),this.heap=t,this.offset=0}return $r(e,[{key:"type",get:function(){return this.heap.getbyaddr(this.offset)}},{key:"op1",get:function(){return this.heap.getbyaddr(this.offset+1)}},{key:"op2",get:function(){return this.heap.getbyaddr(this.offset+2)}},{key:"op3",get:function(){return this.heap.getbyaddr(this.offset+3)}}]),e}();(function(e){e[e.Allocated=0]="Allocated",e[e.Freed=1]="Freed",e[e.Purged=2]="Purged",e[e.Pointer=3]="Pointer"})(Mr||(Mr={}))
...
return e||(this._macros=e=this.populateBuiltins()),e},e.prototype.populateBuiltins=function(){return we()},$r(e,[{key:"transaction",get:function(){return this._transaction}}]),e}(),ni=function(){function e(e,t){var n,r
...
return e.guid=""+this._guid,{guid:this._guid,type:this.type,details:e,children:this.children.toArray().map(function(e){return e.toJSON()})}},n}(It),oi=function(e){function r(t,i,o,s){Tt(this,r)
...
p.execute(a,function(t){t.stack=fi.restore(u),t.updatingOpcodeStack.push(h),t.updateWith(e),t.updatingOpcodeStack.push(i)}),this.prev=l,this.next=c},r.prototype.toJSON=function(){var t=e.prototype.toJSON.call(this),n=t.details
...
n.didDestroy(),j(n),this.updating.remove(n),delete t[e],this.didDelete=!0},e.prototype.done=function(){this.opcode.didInitializeChildren(this.didInsert||this.didDelete)},e}(),ai=function(e){function r(i,o,s,a,u){Tt(this,r)
...
for(n=0;n<t.length;n++)r=t[n],r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}return function(t,n,r){return n&&e(t.prototype,n),r&&e(t,r),t}}(),fi=function(){function e(t,n,r){Ot(this,e),this.stack=t,this.fp=n,this.sp=r}return e.empty=function(){return new this([],0,-1)},e.restore=function(e){return new this(e.slice(),0,e.length-1)},e.prototype.isEmpty=function(){return-1===this.sp},e.prototype.push=function(e){this.stack[++this.sp]=e},e.prototype.dup=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:this.sp
this.push(this.stack[e])},e.prototype.pop=function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:1,t=this.stack[this.sp]
return this.sp-=e,t},e.prototype.peek=function(){return this.stack[this.sp]},e.prototype.fromBase=function(e){return this.stack[this.fp-e]},e.prototype.fromTop=function(e){return this.stack[this.sp-e]},e.prototype.capture=function(e){var t=this.sp+1
return this.stack.slice(t-e,t)},e.prototype.reset=function(){this.stack.length=0},e.prototype.toArray=function(){return this.stack.slice(this.fp,this.sp+1)},e}(),pi=function(){function e(n,r,i,o){Ot(this,e),this.env=n,this.elementStack=o,this.dynamicScopeStack=new t.Stack,this.scopeStack=new t.Stack,this.updatingOpcodeStack=new t.Stack,this.cacheGroups=new t.Stack,this.listBlockStack=new t.Stack,this.stack=fi.empty(),this.pc=-1,this.ra=-1,this.s0=null,this.s1=null,this.t0=null,this.t1=null,this.env=n,this.heap=n.program.heap,this.constants=n.program.constants,this.elementStack=o,this.scopeStack.push(r),this.dynamicScopeStack.push(i)}return e.prototype.fetch=function(e){this.stack.push(this[Rt[e]])},e.prototype.load=function(e){this[Rt[e]]=this.stack.pop()},e.prototype.fetchValue=function(e){return this[Rt[e]]},e.prototype.loadValue=function(e,t){this[Rt[e]]=t},e.prototype.pushFrame=function(){this.stack.push(this.ra),this.stack.push(this.fp),this.fp=this.sp-1},e.prototype.popFrame=function(){this.sp=this.fp-1,this.ra=this.stack.fromBase(0),this.fp=this.stack.fromBase(-1)},e.prototype.goto=function(e){this.pc=(0,t.typePos)(this.pc+e)},e.prototype.call=function(e){var t=this.heap.getaddr(e)
...
return o||(o=JSON.parse(i)),new mi(s,a,e,o)}}},e.NULL_REFERENCE=Ht,e.UNDEFINED_REFERENCE=Ft,e.PrimitiveReference=jt,e.ConditionalReference=zt,e.OpcodeBuilderDSL=nr,e.compileLayout=function(e,t){var n=new Kn(t)
return e.compile(n),n.compile()},e.CompiledStaticTemplate=qn,e.CompiledDynamicTemplate=Wn,e.IAttributeManager=Br,e.AttributeManager=Br,e.PropertyManager=Ur,e.INPUT_VALUE_PROPERTY_MANAGER=Wr,e.defaultManagers=ht,e.defaultAttributeManagers=mt,e.defaultPropertyManagers=dt,e.readDOMAttr=function(e,t){var n=e.namespaceURI===Ar,r=Ie(e,t),i=r.type,o=r.normalized
...
e.isSafeString=K,e.Scope=Qr,e.Environment=ti,e.PartialDefinition=function e(t,n){kt(this,e),this.name=t,this.template=n},e.ComponentDefinition=function e(t,n,r){B(this,e),this[On]=!0,this.name=t,this.manager=n,this.ComponentClass=r},e.isComponentDefinition=U,e.DOMChanges=Fr,e.IDOMChanges=jr,e.DOMTreeConstruction=Hr,e.isWhitespace=function(e){return Nr.test(e)},e.insertHTMLBefore=at,e.ElementStack=wn,e.ConcreteBounds=gn}),e("@glimmer/util",["exports"],function(e){"use strict"
function t(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function n(e){return e._guid=++_}function r(e){return e._guid||n(e)}function i(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function o(){}function s(){return new o}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}var u,l="http://www.w3.org/1999/xlink",c="http://www.w3.org/XML/1998/namespace",f="http://www.w3.org/2000/xmlns/",p={"xlink:actuate":l,"xlink:arcrole":l,"xlink:href":l,"xlink:role":l,"xlink:show":l,"xlink:title":l,"xlink:type":l,"xml:base":c,"xml:lang":c,"xml:space":c,xmlns:f,"xmlns:xlink":f};(function(e){e[e.Trace=0]="Trace",e[e.Debug=1]="Debug",e[e.Warn=2]="Warn",e[e.Error=3]="Error"})(u||(e.LogLevel=u={}))
...
return this.forEachNode(function(t){return e.push(t)}),e},e.prototype.nextNode=function(e){return e===this._tail?null:e.next},e.prototype.prevNode=function(e){return e===this._head?null:e.prev},e.prototype.isEmpty=function(){return!1},e}(),O=new x(null,null),S=function(){if("function"!=typeof WeakMap)return!1
var e=new WeakMap
return"[object WeakMap]"===Object.prototype.toString.call(e)}(),A="undefined"!=typeof Uint32Array,k=void 0
k=A?Uint32Array:Array
var R=k,P=S?Object.freeze([]):[]
...
return n},e.ensureGuid=r,e.initializeGuid=n,e.Stack=C,e.DictSet=E,e.dict=s,e.EMPTY_SLICE=O,e.LinkedList=T,e.ListNode=function e(t){a(this,e),this.next=null,this.prev=null,this.value=t},e.ListSlice=x,e.A=R,e.EMPTY_ARRAY=P,e.HAS_NATIVE_WEAKMAP=S,e.unwrap=function(e){if(null===e||void 0===e)throw new Error("Expected value to be present")
...
var p=void 0
if(f.length>0)for(t=a(this.globalOptions),p=t?this.invokeWithOnError:this.invoke,n=this.index;n<f.length;n+=4)if(this.index+=4,s=f[n],u=f[n+1],l=f[n+2],c=f[n+3],null!==u&&p(s,u,l,t,c),this.index!==this._queueBeingFlushed.length&&this.globalOptions.mustYield&&this.globalOptions.mustYield())return 1
...
var e,r,o,s,u=r.length,l=0,c=void 0,f=void 0,p=void 0,h=void 0,d=void 0
if(0!==u){1===u?c=r.shift():2===u?(p=r[0],h=r[1],n(h)?(f=r.shift(),c=r.shift()):null!==p&&t(h)&&h in p?(f=r.shift(),c=f[r.shift()]):i(h)?(c=r.shift(),l=parseInt(r.shift(),10)):c=r.shift()):(s=r[r.length-1],i(s)&&(l=parseInt(r.pop(),10)),p=r[0],d=r[1],n(d)?(f=r.shift(),c=r.shift()):null!==p&&t(d)&&d in p?(f=r.shift(),c=f[r.shift()]):c=r.shift())
var m=a(this.options),g=this._platform.now()+l,v=void 0
return v=m?function(){try{c.apply(f,r)}catch(e){m(e)}}:function(){c.apply(f,r)},this._setTimeout(v,g)}},e.prototype.throttle=function(e,t){var n,r=this,o=new Array(arguments.length)
...
return i(a)?(f=a,c=!1):(f=s.pop(),c=!0===a),f=parseInt(f,10),p=u(e,t,this._debouncees),p>-1&&(r=this._debouncees[p+2],this._debouncees.splice(p,3),this._platform.clearTimeout(r)),h=this._platform.setTimeout(function(){!1===c&&o.run.apply(o,s),(p=l(h,o._debouncees))>-1&&o._debouncees.splice(p,3)},f),c&&-1===p&&this.join.apply(this,s),this._debouncees.push(e,t,h),h},e.prototype.cancelTimers=function(){var e,t
...
return"function"==typeof this.class._initFactory?this.class._initFactory(this):(0,t.setOwner)(r,this.owner),this.class.create(r)},e}(),O=/^[^:]+:[^:]+$/
...
i=t.fullName.length>60?".":new Array(60-t.fullName.length).join("."),(0,r.info)(n,t.fullName,i,this.lookupDescription(t.fullName))},knownForType:function(e){var r,o,s,a=(0,n.get)(this,"namespace"),u=i.String.classify(e),l=new RegExp(u+"$"),c=(0,t.dictionary)(null),f=Object.keys(a)
...
var g=void 0
if(l)i={},i[u]=new T(d),g=i,d=[]
else if(c)for(g={},o=Math.min(d.length,u.length),s=0;s<o;s++)a=u[s],g[a]=d[s]
return{positional:d,named:(0,n.assign)({},m,g,h.named.map)}},r.prototype.create=function(e,t,n,r,i,o){var a=r.view,c=t.ComponentClass,f=n.named.capture(),p=(0,l.processComponentArgs)(f)
...
return new o.RootReference(t.render.controller)},n.prototype.didRenderLayout=function(e){e.finalize()},n}(s.default),f=new c,p=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.create=function(e,t,n,r){return new l(r.outletState.value())},n.prototype.layoutFor=function(e,t,n){return n.getCompiledBlock(d,e.template)},n}(c),h=new p
...
var p={}
if("string"!=typeof l&&l.length>0){for(r=Math.min(l.length,f.length),o=0;o<r;o++)s=l[o],p[s]=f[o]
...
for(f[n.ARGS]=p,t=0;t<l.length;t++)i=l[t],s=e.get(i),u=c[i],"function"==typeof u&&u[o.ACTION]?c[i]=u:s[r.UPDATE]&&(c[i]=new a(s,u)),p[i]=s,f[i]=u
return f.attrs=c,f}
...
return(0,i.isConst)(t)?(r=t.positional,s=t.named,a=r.value(),u=s.value(),l=e(a,u),"object"==typeof l&&null!==l||"function"==typeof l?new f(l):o.PrimitiveReference.create(l)):new n(e,t)},n.prototype.compute=function(){var e=this.helper,t=this.args,n=t.positional,r=t.named
...
var o=0
i&&(o|=ht),Y(e).addToListeners(t,n,r,o),"function"==typeof e.didAddListener&&e.didAddListener(t,n,r)}function f(e,t,n,r){r||"function"!=typeof n||(r=n,n=null)
...
for(u=o.length-3;u>=0;u-=3)l=o[u],c=o[u+1],p=o[u+2],c&&(p&dt||(p&ht&&f(t,r,l,c),l||(l=t),"string"==typeof c?i?n.applyStr(l,c,i):l[c]():i?c.apply(l,i):c.call(l)))
...
return"object"==typeof e&&null!==e?(n=t||Y(e),n.writableTag(g)):o.CONSTANT_TAG}function y(e,t){var n=e.readableTag()
void 0!==n&&n.dirty()
...
if(null!==s&&"object"==typeof s&&s.isDescriptor&&s.didChange&&s.didChange(t,n),o&&i.peekWatching(n)>0&&(C(t,n,i),O(t,n,i),I(t,n,i)),t[bt]&&t[bt](n),o){if(i.isSourceDestroying())return
y(i,n)}}}function E(e,t,n){if(!n.isSourceDestroying()&&n.hasDeps(t)){var r=Ct,i=!r
i&&(r=Ct={}),T(_,e,t,r,n),i&&(Ct=null)}}function C(e,t,n){if(!n.isSourceDestroying()&&n.hasDeps(t)){var r=Tt,i=!r
i&&(r=Tt={}),T(w,e,t,r,n),i&&(Tt=null)}}function T(e,t,r,i,o){var s=void 0,a=void 0,u=n.guidFor(t),l=i[u]
...
void 0!==r&&r.revalidate(t)}function A(){Et++}function k(){--Et<=0&&(_t.clear(),wt.flush())}function R(e,t){A()
...
Et>0&&(i=_t.add(e,t,r),o=N(e,r,i,n)),d(e,r,[e,t],o)}}function I(e,t,n){if(!n.isSourceDestroying()){var r=t+":change",i=void 0
Et>0?(i=wt.add(e,t,r),N(e,r,i,n)):d(e,r,[e,t])}}function j(){this.isDescriptor=!0}function L(e,t,n,r,i){void 0===i&&(i=Y(e))
var o=i.peekWatching(t),s=void 0!==o&&o>0,a=e[t]
null!==a&&"object"==typeof a&&a.isDescriptor&&a.teardown(e,t,i)
var u=void 0
return n instanceof j?(u=n,e[t]=u,M(e.constructor),"function"==typeof n.setup&&n.setup(e,t)):void 0===n||null===n?(u=r,e[t]=r):(u=n,Object.defineProperty(e,t,n)),s&&S(e,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,u),this}function M(e){if(!1!==xt){var t=Y(e).readableCache()
...
1===a?(s.writeWatching(n,0),i=t[n],o=null!==i&&"object"==typeof i&&i.isDescriptor,o&&i.didUnwatch&&i.didUnwatch(t,n),"function"==typeof t.didUnwatchProperty&&t.didUnwatchProperty(n)):a>1&&s.writeWatching(n,a-1)}}}function B(e){return new At(null,null,e)}function U(e,t,n){if("object"==typeof e&&null!==e){var r=n||Y(e),i=r.peekWatching(t)||0
...
1===o?(i.writeWatching(n,0),i.readableChains().remove(n)):o>1&&i.writeWatching(n,o-1)}}}function q(e){return e.match(Ot)[0]}function W(e){return"object"==typeof e&&null!==e}function V(e){return!(W(e)&&e.isDescriptor&&!1===e._volatile)}function K(){return new St}function G(e,t,n){var r=Y(e)
r.writableChainWatchers(K).add(t,n),F(e,t,r)}function $(t,n,r,i){if(W(t)){var o=void 0===i?e.peekMeta(t):i
void 0!==o&&void 0!==o.readableChainWatchers()&&(o=Y(t),o.readableChainWatchers().remove(n,r),H(t,n,o))}}function Q(t,n){if(W(t)){var r,i=e.peekMeta(t)
...
return jt(t,i),i}function X(e){return Ht.get(e)}function J(e){return-1!==Bt.get(e)}function Z(e){return Ut.get(e)}function ee(e){return zt.get(e)}function te(e,t){var n=e[t]
...
if(o!==kt)return o}function ge(e,t){throw new r.Error("Cannot set read-only property '"+t+"' on object: "+n.inspect(e))}function ve(e,t,n){return L(e,t,null),ie(e,t,n)}function ye(e){var t,n=[],r=void 0
...
var u=new Array(i.length),l=void 0,c=void 0,f=Yt()
...
return void 0===i[t]&&(l=o[t]),l||(a=s[t],u=null!==a&&"object"==typeof a&&a.isDescriptor?a:void 0,l=u),void 0!==l&&l instanceof de?(r=Object.create(r),r._getter=n.wrap(r._getter,l._getter),l._setter&&(r._setter?r._setter=n.wrap(r._setter,l._setter):r._setter=l._setter),r):r}function Ke(e,t,r,i,o){var s=void 0
return void 0===o[t]&&(s=i[t]),s=s||e[t],void 0===s||"function"!=typeof s?r:n.wrap(r,s)}function Ge(e,t,r,i){var o=i[t]||e[t]
return null===o||void 0===o?n.makeArray(r):cn(o)?null===r||void 0===r?o:ln.call(o,r):ln.call(n.makeArray(o),r)}function $e(e,t,r,i){var o,s=i[t]||e[t]
if(!s)return r
var a=n.assign({},s),u=!1
for(var l in r)r.hasOwnProperty(l)&&(o=r[l],ze(o)?(u=!0,a[l]=Ke(e,l,o,s,{})):a[l]=o)
return u&&(a._super=n.ROOT),a}function Qe(e,t,n,r,i,o,s,a){if(n instanceof j){if(n===mn&&i[t])return fn
n._getter&&(n=Ve(r,t,n,o,i,e)),i[t]=n,o[t]=void 0}else s&&s.indexOf(t)>=0||"concatenatedProperties"===t||"mergedProperties"===t?n=Ge(e,t,n,o):a&&a.indexOf(t)>-1?n=$e(e,t,n,o):ze(n)&&(n=Ke(e,t,n,o,i)),i[t]=void 0,o[t]=n}function Ye(e,t,n,r,i,o){function s(e){delete n[e],delete r[e]}var a,u=void 0,l=void 0,c=void 0,f=void 0,p=void 0
for(a=0;a<e.length;a++)if(u=e[a],(l=qe(t,u))!==fn)if(l){i.willMergeMixin&&i.willMergeMixin(l),f=We("concatenatedProperties",l,r,i),p=We("mergedProperties",l,r,i)
for(c in l)l.hasOwnProperty(c)&&(o.push(c),Qe(i,c,l[c],t,n,r,f,p))
...
"function"==typeof r&&(tt(e,t,r.__ember_observesBefore__,Ue),tt(e,t,r.__ember_observes__,Fe),tt(e,t,r.__ember_listens__,f)),"function"==typeof n&&(tt(e,t,n.__ember_observesBefore__,He),tt(e,t,n.__ember_observes__,Me),tt(e,t,n.__ember_listens__,c))}function rt(e,t,r){var i,o,s={},a={},u=Y(e),l=[],c=void 0,f=void 0,p=void 0
for(e._super=n.ROOT,Ye(t,u,s,a,e,l),i=0;i<l.length;i++)if("constructor"!==(c=l[i])&&a.hasOwnProperty(c)&&(p=s[c],f=a[c],p!==mn)){for(;p&&p instanceof st;)o=et(e,p,s,a),p=o.desc,f=o.value
void 0===p&&void 0===f||(nt(e,c,f),Xe(c)&&u.writeBindings(c,f),L(e,c,p,f,u))}return r||Ze(e,u),e}function it(e,t,r){var i=n.guidFor(e)
if(r[i])return!1
...
return o.__ember_observes__=s,o}function ut(e,t){this.type=e,this.name=t,this._super$Constructor(lt),yn.oneWay.call(this)}function lt(e){var t=this[e],r=n.getOwner(this)||this.container
return r.lookup(t.type+":"+(t.name||e))}s="default"in s?s.default:s,a="default"in a?a.default:a,u="default"in u?u.default:u
var ct,ft,pt="object"==typeof t.context.imports.Ember&&t.context.imports.Ember||{}
...
var bt=n.symbol("PROPERTY_DID_CHANGE"),_t=new yt,wt=new yt,Et=0,Ct=void 0,Tt=void 0;(function(){var e=Object.create(Object.prototype,{prop:{configurable:!0,value:1}})
Object.defineProperty(e,"prop",{configurable:!0,value:2}),e.prop})()
var xt=!1,Ot=/^([^\.]+)/,St=function(){function e(){this.chains=Object.create(null)}return e.prototype.add=function(e,t){var n=this.chains[e]
...
t&&t.length>1&&(n=q(t),r=t.slice(n.length+1),o.unchain(n,r)),--o.count<=0&&(i[o._key]=void 0,o.destroy())},e.prototype.notify=function(e,t){e&&this._watching&&(n=this._parent.value(),n!==this._object&&($(this._object,this._key,this),W(n)?(this._object=n,G(n,this._key,this)):this._object=void 0),this._value=void 0)
var n,r,i=this._chains
if(void 0!==i){r=void 0
for(var o in i)void 0!==(r=i[o])&&r.notify(e,t)}t&&this._parent&&this._parent.populateAffected(this._key,1,t)},e.prototype.populateAffected=function(e,t,n){this._key&&(e=this._key+"."+e),this._parent?this._parent.populateAffected(e,t+1,n):t>1&&n.push(this.value(),e)},e}(),kt=n.symbol("undefined"),Rt=[],Pt=function(){function t(e,t){this._cache=void 0,this._weak=void 0,this._watching=void 0,this._mixins=void 0,this._bindings=void 0,this._values=void 0,this._deps=void 0,this._chainWatchers=void 0,this._chains=void 0,this._tag=void 0,this._tags=void 0,this._factory=void 0,this._flags=0,this.source=e,this.proto=void 0,this.parent=t,this._listeners=void 0,this._listenersFinalized=!1,this._suspendedListeners=void 0}return t.prototype.isInitialized=function(e){return this.proto!==e},t.prototype.destroy=function(){if(!this.isMetaDestroyed()){var t,n=void 0,r=void 0,i=void 0,o=this.readableChains()
...
for(var Nt in mt)Pt.prototype[Nt]=mt[Nt]
var Dt={writable:!0,configurable:!0,enumerable:!1,value:null},It={name:"__ember_meta__",descriptor:Dt},jt=void 0
e.peekMeta=void 0,n.HAS_NATIVE_WEAKMAP?(ct=Object.getPrototypeOf,ft=new WeakMap,jt=function(e,t){ft.set(e,t)},e.peekMeta=function(e){for(var t=e,n=void 0;void 0!==t&&null!==t;){if(void 0!==(n=ft.get(t)))return n
t=ct(t)}}):(jt=function(e,t){e.__defineNonEnumerable?e.__defineNonEnumerable(It):Object.defineProperty(e,"__ember_meta__",Dt),e.__ember_meta__=t},e.peekMeta=function(e){return e.__ember_meta__})
var Lt=function(){function e(e,t,n,r){this.size=0,this.misses=0,this.hits=0,this.limit=e,this.func=t,this.key=n,this.store=r||new Mt}return e.prototype.get=function(e){var t=void 0===this.key?e:this.key(e),n=this.store.get(t)
...
return o&&s===u?u:(_(e,t,r),o?i[t]=void 0:pe(this,e,t,r),i[t]=void 0===u?kt:u,w(e,t,r),u)},Vt.teardown=function(e,t,n){if(!this._volatile){var r=n.readableCache()
...
return i[t]!==Kt&&(i[t]=Kt,pe(this,e,t,r)),n},t.prototype.set=function(e,t,n){return ie(e,this.altKey,n)},t.prototype.readOnly=function(){return this.set=ge,this},t.prototype.oneWay=function(){return this.set=ve,this},t}(j)
Gt.prototype._meta=void 0,Gt.prototype.meta=de.prototype.meta
var $t=[],Qt={},Yt=function(){var e="undefined"!=typeof window?window.performance||{}:{},t=e.now||e.mozNow||e.webkitNow||e.msNow||e.oNow
...
return void 0===t&&(t=kt),Y(e).writableWeak()[this._id]=t,this},t.prototype.has=function(t){if(!Ce(t))return!1
var n,r=e.peekMeta(t)
return void 0!==r&&void 0!==(n=r.readableWeak())&&void 0!==n[this._id]},t.prototype.delete=function(t){return!!this.has(t)&&(delete e.peekMeta(t).writableWeak()[this._id],!0)},t.prototype.toString=function(){return"[object WeakMap]"},t}(),rn=n.HAS_NATIVE_WEAKMAP?WeakMap:nn,on=new u(["sync","actions","destroy"],{GUID_KEY:n.GUID_KEY,sync:{before:A,after:k},defaultQueue:"actions",onBegin:function(e){Se.currentRunLoop=e},onEnd:function(e,t){Se.currentRunLoop=t},onErrorTarget:Zt,onErrorMethod:"onerror"})
Se.join=function(){return on.join.apply(on,arguments)},Se.bind=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
return function(){var e,n,r
for(e=arguments.length,n=Array(e),r=0;r<e;r++)n[r]=arguments[r]
return Se.join.apply(Se,t.concat(n))}},Se.backburner=on,Se.currentRunLoop=null,Se.queues=on.queueNames,Se.begin=function(){on.begin()},Se.end=function(){on.end()},Se.schedule=function(){return on.schedule.apply(on,arguments)},Se.hasScheduledTimers=function(){return on.hasTimers()},Se.cancelTimers=function(){on.cancelTimers()},Se.sync=function(){on.currentInstance&&on.currentInstance.queues.sync.flush()},Se.later=function(){return on.later.apply(on,arguments)},Se.once=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
return t.unshift("actions"),on.scheduleOnce.apply(on,t)},Se.scheduleOnce=function(){return on.scheduleOnce.apply(on,arguments)},Se.next=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
return t.push(1),on.later.apply(on,t)},Se.cancel=function(e){return on.cancel(e)},Se.debounce=function(){return on.debounce.apply(on,arguments)},Se.throttle=function(){return on.throttle.apply(on,arguments)},Se._addQueue=function(e,t){-1===Se.queues.indexOf(e)&&Se.queues.splice(Se.queues.indexOf(t)+1,0,e)}
...
return t.presenceSet=Re(this.presenceSet),t.list=this.toArray(),t.size=this.size,t}},De.create=function(){return new this},De.prototype={constructor:De,size:0,get:function(e){if(0!==this.size){return this._values[n.guidFor(e)]}},set:function(e,t){var r=this._keys,i=this._values,o=n.guidFor(e),s=-0===e?0:e
...
2===arguments.length?(r=arguments[1],n=function(n){return e.call(r,t.get(n),n,t)}):n=function(n){return e(t.get(n),n,t)},this._keys.forEach(n)}},clear:function(){this._keys.clear(),this._values=Object.create(null),this.size=0},copy:function(){return Pe(this,new De)}},Ie.create=function(e){return e?new Ie(e):new De},Ie.prototype=Object.create(De.prototype),Ie.prototype.constructor=Ie,Ie.prototype._super$constructor=De,Ie.prototype._super$get=De.prototype.get,Ie.prototype.get=function(e){var t,n=this.has(e)
return n?this._super$get(e):(t=this.defaultValue(e),this.set(e,t),t)},Ie.prototype.copy=function(){return Pe(this,new(0,this.constructor)({defaultValue:this.defaultValue}))}
...
var ln=Array.prototype.concat,cn=Array.isArray,fn={}
...
var mn=new j
mn.toString=function(){return"(Required Property)"},st.prototype=new j,ut.prototype=Object.create(j.prototype)
var gn=ut.prototype,vn=de.prototype,yn=Gt.prototype
gn._super$Constructor=de,gn.get=vn.get,gn.readOnly=vn.readOnly,gn.teardown=vn.teardown
...
$t.splice(n,1),Qt={}},e.getOnerror=function(){return Jt},e.setOnerror=function(e){Jt=e},e.dispatchError=function(e){en?en(e):Ee(e)},e.setDispatchOverride=function(e){en=e},e.getDispatchOverride=function(){return en},e.META_DESC=Dt,e.meta=Y,e.Cache=Lt,e._getPath=ne,e.get=te,e.getWithDefault=function(e,t,n){var r=te(e,t)
...
return n&&n.watchedEvents()||[]},e.isNone=Te,e.isEmpty=xe,e.isBlank=Oe,e.isPresent=function(e){return!Oe(e)},e.run=Se,e.ObserverSet=yt,e.beginPropertyChanges=A,e.changeProperties=R,e.endPropertyChanges=k,e.overrideChains=S,e.propertyDidChange=w,e.propertyWillChange=_,e.PROPERTY_DID_CHANGE=bt,e.defineProperty=L,e.Descriptor=j,e._hasCachedComputedProperties=function(){xt=!0},e.watchKey=F,e.unwatchKey=H,e.ChainNode=At,e.finishChains=function(e){var t=e.readableChainWatchers()
...
void 0!==n&&n.destroy()}
e.isWatching=function(e,t){return ce(e,t)>0},e.unwatch=fe,e.watch=le,e.watcherCount=ce,e.libraries=an,e.Libraries=sn,e.Map=De,e.MapWithDefault=Ie,e.OrderedSet=Ne,e.getProperties=function(e){var t={},n=arguments,r=1
...
for(n=0;n<r.length;n++)i=r[n],ie(e,i,t[i])}),t):t},e.expandProperties=ae,e._suspendObserver=Be,e._suspendObservers=function(e,t,n,r,i){return h(e,t.map(je),n,r,i)},e.addObserver=Me,e.observersFor=function(e,t){return m(e,je(t))},e.removeObserver=Fe,e._addBeforeObserver=He,e._removeBeforeObserver=Ue,e.Mixin=pn,e.aliasMethod=function(e){return new st(e)},e._immediateObserver=function(){var e
...
return s||(i[t]=g())},e.tagFor=v,e.markObjectAsDirty=y,e.replace=function(e,t,n,r){for(var i=[].concat(r),o=[],s=t,a=n,u=void 0,l=void 0;i.length;)u=a>6e4?6e4:a,u<=0&&(u=0),l=i.splice(0,6e4),l=[s,u].concat(l),s+=6e4,a-=u,o=o.concat(bn.apply(e,l))
...
for(n=0;n<e.length;n+=3)t(e[n]).to(e[n+1],e[n+2])}},e.prototype.mount=function(n){var r,a,u,l,c,f,p,h=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},d=this.options.resolveRouteMap(n),m=n
h.as&&(m=h.as)
...
this.enableLoadingSubstates&&(c=m+"_loading",f="application_loading",p=(0,t.assign)({localFullName:f},v),o(this,c,{resetNamespace:h.resetNamespace}),this.options.addRouteForEngine(c,p),c=m+"_error",f="application_error",p=(0,t.assign)({localFullName:f},v),o(this,c,{resetNamespace:h.resetNamespace,path:_}),this.options.addRouteForEngine(c,p)),this.options.addRouteForEngine(g,w),this.push(y,g,b)},e}()
...
i&&(c=i.into&&i.into.replace(/\//g,"."),f=i.outlet,p=i.controller,h=i.model),f=f||"main",n?(a=e.routeName,u=e.templateName||a):(a=r.replace(/\//g,"."),u=a),p||(p=n?e.controllerName||s.lookup("controller:"+a):s.lookup("controller:"+a)||e.controllerName||e.routeName),"string"==typeof p&&(o=p,p=s.lookup("controller:"+o)),h&&p.set("model",h)
...
u[y]=!0
var b=i.Object.extend(i.ActionHandler,i.Evented,{queryParams:{},_setRouteName:function(e){this.routeName=e,this.fullRouteName=v((0,t.getOwner)(this),e)},_qp:(0,n.computed)(function(){var e,r,a,u,l,c,f,p,h,d,g,v=this,y=void 0,b=this.controllerName||this.routeName,_=(0,t.getOwner)(this),w=_.lookup("controller:"+b),E=(0,n.get)(this,"queryParams"),C=Object.keys(E).length>0
w?(e=(0,n.get)(w,"queryParams")||{},r=(0,s.normalizeControllerQueryParams)(e),y=m(r,E)):C&&(w=(0,o.default)(_,b),y=E)
var T=[],x={},O=[]
for(var S in y)y.hasOwnProperty(S)&&"unknownProperty"!==S&&"_super"!==S&&(a=y[S],u=a.scope||"model",l=void 0,"controller"===u&&(l=[]),c=a.as||this.serializeQueryParamKey(S),f=(0,n.get)(w,S),Array.isArray(f)&&(f=(0,i.A)(f.slice())),p=a.type||(0,i.typeOf)(f),h=this.serializeQueryParam(f,c,p),d=b+":"+S,g={undecoratedDefaultValue:(0,n.get)(w,S),defaultValue:f,serializedDefaultValue:h,serializedValue:h,type:p,urlKey:c,prop:S,scopedPropertyName:d,controllerName:b,route:this,parts:l,values:null,scope:u},x[S]=x[c]=x[d]=g,T.push(g),O.push(S))
return{qps:T,map:x,propertyNames:O,states:{inactive:function(e,t){var n=x[e]
...
if(r){var i,o,a,u,l,c,f,p,h,m,g=r.state.handlerInfos,v=this.router,y=v._queryParamsFor(g),b=v._qpUpdates,_=void 0
for((0,s.stashParamNames)(v,g),i=0;i<y.qps.length;++i)o=y.qps[i],a=o.route,u=a.controller,l=o.urlKey in e&&o.urlKey,c=void 0,f=void 0,b&&o.urlKey in b?(c=(0,n.get)(u,o.prop),f=a.serializeQueryParam(c,o.urlKey,o.type)):l?(f=e[l],c=a.deserializeQueryParam(f,o.urlKey,o.type)):(f=o.serializedDefaultValue,c=d(o.defaultValue)),u._qpDelegate=(0,n.get)(a,"_qp.states.inactive"),p=f!==o.serializedValue,p&&(r.queryParamsOnly&&!1!==_&&(h=a._optionsForQueryParam(o),m=(0,n.get)(h,"replace"),m?_=!0:!1===m&&(_=!1)),(0,n.set)(u,o.prop,c)),o.serializedValue=f,o.serializedDefaultValue===f&&!r._keepDefaultQueryParamValues||t.push({value:f,visible:!0,key:l||o.urlKey})
...
if(l){for(e=0;e<l.length;e++){for(c=l[e].handler,n=c.connections,r=void 0,i=0;i<n.length;i++)o=x(p,f,n[i]),p=o.liveRoutes,o.ownState.render.name!==c.routeName&&"main"!==o.ownState.render.outlet||(r=o.ownState)
...
for(r=0,i=f.length;r<i;++r)if(o=this._getQPMeta(f[r]))for(s=0,a=o.qps.length;s<a;++s)u=o.qps[s],(l=u.prop in n&&u.prop||u.scopedPropertyName in n&&u.scopedPropertyName||u.urlKey in n&&u.urlKey)&&l!==u.scopedPropertyName&&(n[u.scopedPropertyName]=n[l],delete n[l])},_hydrateUnsuppliedQueryParams:function(e,t,n){var r,i,o,s,a,u,c,f=e.handlerInfos,p=this._bucketCache
for(r=0;r<f.length;++r)if(i=this._getQPMeta(f[r]))for(o=0,s=i.qps.length;o<s;++o)a=i.qps[o],u=a.prop in t&&a.prop||a.scopedPropertyName in t&&a.scopedPropertyName||a.urlKey in t&&a.urlKey,u?u!==a.scopedPropertyName&&(t[a.scopedPropertyName]=t[u],delete t[u]):(c=(0,l.calculateCacheKey)(a.route.fullRouteName,a.parts,e.params),t[a.scopedPropertyName]=p.lookup(c,a.prop,a.defaultValue))},_scheduleLoadingEvent:function(e,t){this._cancelSlowTransitionTimer(),this._slowTransitionTimer=r.run.scheduleOnce("routerTransitions",this,"_handleSlowTransition",e,t)},currentState:null,targetState:null,_handleSlowTransition:function(e,t){this._routerMicrolib.activeTransition&&(this.set("targetState",c.default.create({emberRouter:this,routerJs:this._routerMicrolib,routerJsState:this._routerMicrolib.activeTransition.state})),e.trigger(!0,"loading",e,t))},_cancelSlowTransitionTimer:function(){this._slowTransitionTimer&&r.run.cancel(this._slowTransitionTimer),this._slowTransitionTimer=null},_markErrorAsHandled:function(e){this._handledErrors[e]=!0},_isErrorHandled:function(e){return this._handledErrors[e]},_clearHandledError:function(e){delete this._handledErrors[e]},_getEngineInstance:function(e){var n,r=e.name,i=e.instanceId,o=e.mountPoint,s=this._engineInstances
...
if(w.proto=this,i&&(w.factory=i,i=null),t)for(s=t,t=null,a=this.concatenatedProperties,u=this.mergedProperties,l=a&&a.length>0,c=u&&u.length>0,f=0;f<s.length;f++)if(h=s[f])for(m=Object.keys(h),g=0;g<m.length;g++)v=m[g],y=h[v],(0,r.detectBinding)(v)&&w.writeBindings(v,y),b=this[v],_=null!==b&&"object"==typeof b&&b.isDescriptor,l&&a.indexOf(v)>-1&&(y=b?(0,n.makeArray)(b).concat(y):(0,n.makeArray)(y)),c&&u.indexOf(v)>-1&&(y=(0,n.assign)({},b,y)),_?b.set(this,v,y):"function"!=typeof this.setUnknownProperty||v in this?this[v]=y:this.setUnknownProperty(v,y)
...
for(n=0;n<e.length;n++){for(r=e[n],i=l(h,r.path,f),o=i.names,s=i.shouldDecodes;m<h.length;m++)a=h[m],4!==a.type&&(d=!1,u=u.put(47,!1,!1),c+="/",u=T[a.type](a,u),c+=x[a.type](a))
...
var Y=d(C,{name:null,pivotHandler:null,contexts:null,queryParams:null,initialize:function(e){this.name=e.name,this.pivotHandler=e.pivotHandler,this.contexts=e.contexts||[],this.queryParams=e.queryParams},applyToState:function(e,t,n,r,i){var s=o([this.name].concat(this.contexts)),a=s[0],u=t.handlersFor(a[0]),l=u[u.length-1].handler
return this.applyToHandlers(e,u,n,l,r,null,i)},applyToHandlers:function(e,t,n,r,o,s,a){var u,l,c,f,p,h,d,m,g,v=new y,b=this.contexts.slice(0),_=t.length
...
var X=d(C,{url:null,initialize:function(e){this.url=e.url},applyToState:function(e,t,n){function r(e){if(e&&e.inaccessibleByURL)throw new S(m)
return e}var o,s,a,u,l,c,f,p=new y,h=t.recognize(this.url)
if(!h)throw new S(this.url)
var d=!1,m=this.url
for(c=0,f=h.length;c<f;++c)o=h[c],s=o.handler,a=O("param",{name:s,getHandler:n,params:o.params}),u=a.handler,u?r(u):a.handlerPromise=a.handlerPromise.then(r),l=e.handlerInfos[c],d||a.shouldSupercede(l)?(d=!0,p.handlerInfos[c]=a):p.handlerInfos[c]=l
...
return i&&"replace"===i.urlMethod&&c.method(i.urlMethod),c},replaceWith:function(){return L(this,arguments).method("replace")},generate:function(e){var t,n,r,s,a=o(q.call(arguments,1)),u=a[0],l=a[1],c=new Y({name:e,contexts:u}),f=c.applyToState(this.state,this.recognizer,this.getHandler,null,this.getSerializer),p={}
...
var ge=me,ve=Date.now||function(){return(new Date).getTime()},ye=[],be=void 0,_e=1,we=2,Ee=new O,Ce=new O
...
return i},j.resolve=p,j.reject=function(e,t){var n=this,r=new n(d,t)
return C(r,e),r},j.prototype._guidKey=Te,j.prototype.then=R
...
var f=u(e)
return f.host?l(f.host,t):l(e,u(t).host)}function c(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"top",n="top"===t?"scrollTop":"scrollLeft",r=e.nodeName
if("BODY"===r||"HTML"===r){var i=window.document.documentElement
return(window.document.scrollingElement||i)[n]}return e[n]}function f(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=c(t,"top"),i=c(t,"left"),o=n?-1:1
...
var o={left:t.left,top:t.top,width:t.right-t.left,height:t.bottom-t.top},s="HTML"===e.nodeName?d():{},a=s.width||e.clientWidth||o.right-o.left,u=s.height||e.clientHeight||o.bottom-o.top,l=e.offsetWidth-a,f=e.offsetHeight-u
if(l||f){var h=r(e)
l-=p(h,"x"),f-=p(h,"y"),o.width-=l,o.height-=f}return m(o)}function v(e,t){var n=pe(),i="HTML"===t.nodeName,s=g(e),a=g(t),u=o(e),l=r(t),c=+l.borderTopWidth.split("px")[0],p=+l.borderLeftWidth.split("px")[0],h=m({top:s.top-a.top-c,left:s.left-a.left-p,width:s.width,height:s.height})
if(h.marginTop=0,h.marginLeft=0,!n&&i){var d=+l.marginTop.split("px")[0],v=+l.marginLeft.split("px")[0]
h.top-=c-d,h.bottom-=c-d,h.left-=p-v,h.right-=p-v,h.marginTop=d,h.marginLeft=v}return(n?t.contains(u):t===u&&"BODY"!==u.nodeName)&&(h=f(h,t)),h}function y(e){var t=window.document.documentElement,n=v(e,t),r=Math.max(t.clientWidth,window.innerWidth||0),i=Math.max(t.clientHeight,window.innerHeight||0),o=c(t),s=c(t,"left")
...
return c+(f?"-"+f:"")}function C(e,t,n){return v(n,l(t,n))}function T(e){var t=window.getComputedStyle(e),n=parseFloat(t.marginTop)+parseFloat(t.marginBottom),r=parseFloat(t.marginLeft)+parseFloat(t.marginRight)
...
return i[s]=t[s]+t[u]/2-r[u]/2,i[a]=n===a?t[a]-r[l]:t[x(a)],i}function S(e,t){return Array.prototype.find?e.find(t):e.filter(t)[0]}function A(e,t,n){if(Array.prototype.findIndex)return e.findIndex(function(e){return e[t]===n})
var r=S(e,function(e){return e[t]===n})
return e.indexOf(r)}function k(e,t,r){return(void 0===r?e:e.slice(0,A(e,"name",r))).forEach(function(e){e.function&&console.warn("`modifier.function` is deprecated, use `modifier.fn`!")
...
e.offsets.reference=C(this.state,this.popper,this.reference),e.placement=E(this.options.placement,e.offsets.reference,this.popper,this.reference,this.options.modifiers.flip.boundariesElement,this.options.modifiers.flip.padding),e.originalPlacement=e.placement,e.offsets.popper=O(this.popper,e.offsets.reference,e.placement),e.offsets.popper.position="absolute",e=k(this.modifiers,e),this.state.isCreated?this.options.onUpdate(e):(this.state.isCreated=!0,this.options.onCreate(e))}}function P(e,t){return e.some(function(e){var n=e.name
...
if(void 0!==window.document.body.style[o])return o}return null}function D(){return this.state.isDestroyed=!0,P(this.modifiers,"applyStyle")&&(this.popper.removeAttribute("x-placement"),this.popper.style.left="",this.popper.style.position="",this.popper.style.top="",this.popper.style[N("transform")]=""),this.disableEventListeners(),this.options.removeOnDestroy&&this.popper.parentNode.removeChild(this.popper),this}function I(e,t,n,r){var i="BODY"===e.nodeName,s=i?window:e
s.addEventListener(t,n,{passive:!0}),i||I(o(s.parentNode),t,n,r),r.push(s)}function j(e,t,n,r){n.updateBound=r,window.addEventListener("resize",n.updateBound,{passive:!0})
var i=o(e)
return I(i,"scroll",n.updateBound,n.scrollParents),n.scrollElement=i,n.eventsEnabled=!0,n}function L(){this.state.eventsEnabled||(this.state=j(this.reference,this.options,this.state,this.scheduleUpdate))}function M(e,t){return window.removeEventListener("resize",t.updateBound),t.scrollParents.forEach(function(e){e.removeEventListener("scroll",t.updateBound)}),t.updateBound=null,t.scrollParents=[],t.scrollElement=null,t.eventsEnabled=!1,t}function F(){this.state.eventsEnabled&&(window.cancelAnimationFrame(this.scheduleUpdate),this.state=M(this.reference,this.state))}function H(e){return""!==e&&!isNaN(parseFloat(e))&&isFinite(e)}function B(e,t){Object.keys(t).forEach(function(n){var r="";-1!==["width","height","top","right","bottom","left"].indexOf(n)&&H(t[n])&&(r="px"),e.style[n]=t[n]+r})}function U(e,t){Object.keys(t).forEach(function(n){!1!==t[n]?e.setAttribute(n,t[n]):e.removeAttribute(n)})}function z(e){return B(e.instance.popper,e.styles),U(e.instance.popper,e.attributes),e.arrowElement&&Object.keys(e.arrowStyles).length&&B(e.arrowElement,e.arrowStyles),e}function q(e,t,n,r,i){var o=C(i,t,e),s=E(n.placement,o,t,e,n.modifiers.flip.boundariesElement,n.modifiers.flip.padding)
...
var a=void 0!==o?o:t.gpuAcceleration,u=s(e.instance.popper),l=g(u),c={position:i.position},f={left:Math.floor(i.left),top:Math.floor(i.top),bottom:Math.floor(i.bottom),right:Math.floor(i.right)},p="bottom"===n?"top":"bottom",h="right"===r?"left":"right",d=N("transform"),m=void 0,v=void 0
if(v="bottom"===p?-l.height+f.bottom:f.top,m="right"===h?-l.width+f.right:f.left,a&&d)c[d]="translate3d("+m+"px, "+v+"px, 0)",c[p]=0,c[h]=0,c.willChange="transform"
else{var y="bottom"===p?-1:1,b="right"===h?-1:1
c[p]=v*y,c[h]=m*b,c.willChange=p+", "+h}var _={"x-placement":e.placement}
...
var i=e.placement.split("-")[0],o=e.offsets,s=o.popper,a=o.reference,u=-1!==["left","right"].indexOf(i),l=u?"height":"width",c=u?"Top":"Left",f=c.toLowerCase(),p=u?"left":"top",h=u?"bottom":"right",d=T(n)[l]
a[h]-d<s[f]&&(e.offsets.popper[f]-=s[f]-(a[h]-d)),a[f]+d>s[h]&&(e.offsets.popper[f]+=a[f]+d-s[h])
var g=a[f]+a[l]/2-d/2,v=r(e.instance.popper,"margin"+c).replace("px",""),y=g-m(e.offsets.popper)[f]-v
return y=Math.max(Math.min(s[l]-d,y),0),e.arrowElement=n,e.offsets.arrow={},e.offsets.arrow[f]=Math.round(y),e.offsets.arrow[p]="",e}function G(e){return"end"===e?"start":"start"===e?"end":e}function $(e){var t=arguments.length>1&&void 0!==arguments[1]&&arguments[1],n=ye.indexOf(e),r=ye.slice(n+1).concat(ye.slice(0,n))
...
s&&this.enableEventListeners(),this.state.eventsEnabled=s}return de(e,[{key:"update",value:function(){return R.call(this)}},{key:"destroy",value:function(){return D.call(this)}},{key:"enableEventListeners",value:function(){return L.call(this)}},{key:"disableEventListeners",value:function(){return F.call(this)}}]),e}()
return Ee.Utils=("undefined"!=typeof window?window:global).PopperUtils,Ee.placements=ve,Ee.Defaults=we,Ee}),"undefined"==typeof jQuery)throw new Error("Bootstrap's JavaScript requires jQuery. jQuery must be included before Bootstrap's JavaScript.");(function(e){var t=e.fn.jquery.split(" ")[0].split(".")
...
if(t===f.NEXT?(c=h.LEFT,m=h.NEXT,g=f.LEFT):(c=h.RIGHT,m=h.PREV,g=f.RIGHT),a&&e(a).hasClass(h.ACTIVE))return void(this._isSliding=!1)
...
var l=function(){t.setTransitioning(!1),e(t._element).removeClass(f.COLLAPSING).addClass(f.COLLAPSE).trigger(c.HIDDEN)}
...
if(this._backdrop=document.createElement("div"),this._backdrop.className=f.BACKDROP,r&&e(this._backdrop).addClass(r),e(this._backdrop).appendTo(document.body),e(this._element).on(c.CLICK_DISMISS,function(e){if(n._ignoreBackdropClick)return void(n._ignoreBackdropClick=!1)
...
var t,n="function"==typeof define&&define.amd,r=function(t){var n="Comic Sans MS"===t?"Courier New":"Comic Sans MS",r=e("<div>").css({position:"absolute",left:"-9999px",top:"-9999px",fontSize:"200px"}).text("mmmmmmmmmwwwwwww").appendTo(document.body),i=r.css("fontFamily",n).width(),o=r.css("fontFamily",t+","+n).width()
return r.remove(),i!==o},i=navigator.userAgent,o=/MSIE|Trident/i.test(i)
if(o){var s=/MSIE (\d+[.]\d+)/.exec(i)
s&&(t=parseFloat(s[1])),s=/Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/.exec(i),s&&(t=parseFloat(s[1]))}var a=/Edge\/\d+/.test(i),u=!!window.CodeMirror
if(!u&&n)if("function"==typeof __webpack_require__)try{require.resolve("codemirror"),u=!0}catch(e){}else if(void 0!==require)if(void 0!==require.resolve)try{require.resolve("codemirror"),u=!0}catch(e){}else void 0!==require.specified&&(u=require.specified("codemirror"))
var l="ontouchstart"in window||navigator.MaxTouchPoints>0||navigator.msMaxTouchPoints>0,c={isMac:navigator.appVersion.indexOf("Mac")>-1,isMSIE:o,isEdge:a,isFF:!a&&/firefox/i.test(i),isPhantom:/PhantomJS/i.test(i),isWebkit:!a&&/webkit/i.test(i),isChrome:!a&&/chrome/i.test(i),isSafari:!a&&/safari/i.test(i),browserVersion:t,jqueryVersion:parseFloat(e.fn.jquery),isSupportAmd:n,isSupportTouch:l,hasCodeMirror:u,isFontInstalled:r,isW3CRangeSupport:!!document.createRange},f=function(){var t=function(e){return function(t){return e===t}},n=function(e,t){return e===t},r=function(e){return function(t,n){return t[e]===n[e]}},i=function(){return!0},o=function(){return!1},s=function(e){return function(){return!e.apply(e,arguments)}},a=function(e,t){return function(n){return e(n)&&t(n)}},u=0
return{eq:t,eq2:n,peq2:r,ok:i,fail:o,self:function(e){return e},not:s,and:a,invoke:function(e,t){return function(){return e[t].apply(e,arguments)}},uniqueId:function(e){var t=++u+""
return e?e+t:t},rect2bnd:function(t){var n=e(document)
...
clearTimeout(r),r=setTimeout(s,t),a&&e.apply(i,o)}}}}(),p=function(){var t=function(e){return e[0]},n=function(e){return e[e.length-1]},r=function(e){return e.slice(0,e.length-1)},i=function(e){return e.slice(1)},o=function(e,t){for(var n=0,r=e.length;n<r;n++){var i=e[n]
if(t(i))return i}},s=function(e,t){for(var n=0,r=e.length;n<r;n++)if(!t(e[n]))return!1
return!0},a=function(t,n){return e.inArray(n,t)},u=function(e,t){return-1!==a(e,t)},l=function(e,t){return t=t||f.self,e.reduce(function(e,n){return e+t(n)},0)},c=function(e){for(var t=[],n=-1,r=e.length;++n<r;)t[n]=e[n]
return t},p=function(e){return!e||!e.length},h=function(e,r){return e.length?i(e).reduce(function(e,t){var i=n(e)
return r(n(i),t)?i[i.length]=t:e[e.length]=[t],e},[[t(e)]]):[]},d=function(e){for(var t=[],n=0,r=e.length;n<r;n++)e[n]&&t.push(e[n])
return t},m=function(e){for(var t=[],n=0,r=e.length;n<r;n++)u(t,e[n])||t.push(e[n])
return t},g=function(e,t){var n=a(e,t)
return-1===n?null:e[n+1]}
return{head:t,last:n,initial:r,tail:i,prev:function(e,t){var n=a(e,t)
return-1===n?null:e[n-1]},next:g,find:o,contains:u,all:s,sum:l,from:c,isEmpty:p,clusterBy:h,compact:d,unique:m}}(),h=String.fromCharCode(160),d=function(){var t=function(t){return t&&e(t).hasClass("note-editable")},n=function(t){return t&&e(t).hasClass("note-control-sizing")},r=function(e){return e=e.toUpperCase(),function(t){return t&&t.nodeName.toUpperCase()===e}},i=function(e){return e&&3===e.nodeType},o=function(e){return e&&1===e.nodeType},s=function(e){return e&&/^BR|^IMG|^HR|^IFRAME|^BUTTON|^INPUT/.test(e.nodeName.toUpperCase())},a=function(e){return!t(e)&&(e&&/^DIV|^P|^LI|^H[1-7]/.test(e.nodeName.toUpperCase()))},u=function(e){return e&&/^H[1-7]/.test(e.nodeName.toUpperCase())},l=r("PRE"),m=r("LI"),g=function(e){return a(e)&&!m(e)},v=r("TABLE"),y=r("DATA"),b=function(e){return!(T(e)||_(e)||w(e)||a(e)||v(e)||C(e)||y(e))},_=function(e){return e&&/^UL|^OL/.test(e.nodeName.toUpperCase())},w=r("HR"),E=function(e){return e&&/^TD|^TH/.test(e.nodeName.toUpperCase())},C=r("BLOCKQUOTE"),T=function(e){return E(e)||C(e)||t(e)},x=r("A"),O=function(e){return b(e)&&!!j(e,a)},S=function(e){return b(e)&&!j(e,a)},A=r("BODY"),k=function(e,t){return e.nextSibling===t||e.previousSibling===t},R=function(e,t){t=t||f.ok
var n=[]
return e.previousSibling&&t(e.previousSibling)&&n.push(e.previousSibling),n.push(e),e.nextSibling&&t(e.nextSibling)&&n.push(e.nextSibling),n},P=c.isMSIE&&c.browserVersion<11?"&nbsp;":"<br>",N=function(e){return i(e)?e.nodeValue.length:e?e.childNodes.length:0},D=function(e){var t=N(e)
return 0===t||(!i(e)&&1===t&&e.innerHTML===P||!(!p.all(e.childNodes,i)||""!==e.innerHTML))},I=function(e){s(e)||N(e)||(e.innerHTML=P)},j=function(e,n){for(;e;){if(n(e))return e
if(t(e))break
e=e.parentNode}return null},L=function(e,n){for(e=e.parentNode;e&&1===N(e);){if(n(e))return e
if(t(e))break
e=e.parentNode}return null},M=function(e,n){n=n||f.fail
var r=[]
return j(e,function(e){return t(e)||r.push(e),n(e)}),r},F=function(e,t){var n=M(e)
return p.last(n.filter(t))},H=function(t,n){for(var r=M(t),i=n;i;i=i.parentNode)if(e.inArray(i,r)>-1)return i
return null},B=function(e,t){t=t||f.fail
for(var n=[];e&&!t(e);)n.push(e),e=e.previousSibling
return n},U=function(e,t){t=t||f.fail
for(var n=[];e&&!t(e);)n.push(e),e=e.nextSibling
return n},z=function(e,t){var n=[]
return t=t||f.ok,function r(i){e!==i&&t(i)&&n.push(i)
for(var o=0,s=i.childNodes.length;o<s;o++)r(i.childNodes[o])}(e),n},q=function(t,n){var r=t.parentNode,i=e("<"+n+">")[0]
return r.insertBefore(i,t),i.appendChild(t),i},W=function(e,t){var n=t.nextSibling,r=t.parentNode
return n?r.insertBefore(e,n):r.appendChild(e),e},V=function(t,n){return e.each(n,function(e,n){t.appendChild(n)}),t},K=function(e){return 0===e.offset},G=function(e){return e.offset===N(e.node)},$=function(e){return K(e)||G(e)},Q=function(e,t){for(;e&&e!==t;){if(0!==Z(e))return!1
e=e.parentNode}return!0},Y=function(e,t){if(!t)return!1
for(;e&&e!==t;){if(Z(e)!==N(e.parentNode)-1)return!1
e=e.parentNode}return!0},X=function(e,t){return K(e)&&Q(e.node,t)},J=function(e,t){return G(e)&&Y(e.node,t)},Z=function(e){for(var t=0;e=e.previousSibling;)t+=1
return t},ee=function(e){return!!(e&&e.childNodes&&e.childNodes.length)},te=function(e,n){var r,i
if(0===e.offset){if(t(e.node))return null
r=e.node.parentNode,i=Z(e.node)}else ee(e.node)?(r=e.node.childNodes[e.offset-1],i=N(r)):(r=e.node,i=n?0:e.offset-1)
return{node:r,offset:i}},ne=function(e,n){var r,i
if(N(e.node)===e.offset){if(t(e.node))return null
r=e.node.parentNode,i=Z(e.node)+1}else ee(e.node)?(r=e.node.childNodes[e.offset],i=0):(r=e.node,i=n?N(e.node):e.offset+1)
return{node:r,offset:i}},re=function(e,t){return e.node===t.node&&e.offset===t.offset},ie=function(e){if(i(e.node)||!ee(e.node)||D(e.node))return!0
var t=e.node.childNodes[e.offset-1],n=e.node.childNodes[e.offset]
return!(t&&!s(t)||n&&!s(n))},oe=function(e,t){for(;e;){if(t(e))return e
e=te(e)}return null},se=function(e,t){for(;e;){if(t(e))return e
e=ne(e)}return null},ae=function(e){if(!i(e.node))return!1
var t=e.node.nodeValue.charAt(e.offset-1)
return t&&" "!==t&&t!==h},ue=function(e,t,n,r){for(var i=e;i&&(n(i),!re(i,t));){var o=r&&e.node!==i.node&&t.node!==i.node
i=ne(i,o)}},le=function(e,t){return M(t,f.eq(e)).map(Z).reverse()},ce=function(e,t){for(var n=e,r=0,i=t.length;r<i;r++)n=n.childNodes.length<=t[r]?n.childNodes[n.childNodes.length-1]:n.childNodes[t[r]]
return n},fe=function(e,t){var n=t&&t.isSkipPaddingBlankHTML,r=t&&t.isNotSplitEdgePoint
if($(e)&&(i(e.node)||r)){if(K(e))return e.node
if(G(e))return e.node.nextSibling}if(i(e.node))return e.node.splitText(e.offset)
var o=e.node.childNodes[e.offset],s=W(e.node.cloneNode(!1),e.node)
return V(s,U(o)),n||(I(e.node),I(s)),s},pe=function(e,t,n){var r=M(t.node,f.eq(e))
return r.length?1===r.length?fe(t,n):r.reduce(function(e,r){return e===t.node&&(e=fe(t,n)),fe({node:r,offset:e?d.position(e):N(r)},n)}):null},he=function(e,t){var n,r,i=t?a:T,o=M(e.node,i),s=p.last(o)||e.node
i(s)?(n=o[o.length-2],r=s):(n=s,r=n.parentNode)
var u=n&&pe(n,e,{isSkipPaddingBlankHTML:t,isNotSplitEdgePoint:t})
return u||r!==e.node||(u=e.node.childNodes[e.offset]),{rightNode:u,container:r}},de=function(e){return document.createElement(e)},me=function(e){return document.createTextNode(e)},ge=function(e,t){if(e&&e.parentNode){if(e.removeNode)return e.removeNode(t)
var n=e.parentNode
if(!t){var r,i,o=[]
for(r=0,i=e.childNodes.length;r<i;r++)o.push(e.childNodes[r])
for(r=0,i=o.length;r<i;r++)n.insertBefore(o[r],e)}n.removeChild(e)}},ve=function(e,n){for(;e&&!t(e)&&n(e);){var r=e.parentNode
ge(e),e=r}},ye=function(e,t){if(e.nodeName.toUpperCase()===t.toUpperCase())return e
var n=de(t)
return e.style.cssText&&(n.style.cssText=e.style.cssText),V(n,p.from(e.childNodes)),W(n,e),ge(e),n},be=r("TEXTAREA"),_e=function(e,t){var n=be(e[0])?e.val():e.html()
return t?n.replace(/[\n\r]/g,""):n},we=function(t,n){var r=_e(t)
if(n){var i=/<(\/?)(\b(?!!)[^>\s]*)(.*?)(\s*\/?>)/g
...
return e+(r||i?"\n":"")}),r=e.trim(r)}return r},Ee=function(t){var n=e(t),r=n.offset(),i=n.outerHeight(!0)
return{left:r.left,top:r.top+i}},Ce=function(e,t){Object.keys(t).forEach(function(n){e.on(n,t[n])})},Te=function(e,t){Object.keys(t).forEach(function(n){e.off(n,t[n])})},xe=function(e){return e&&!d.isText(e)&&p.contains(e.classList,"note-styletag")}
return{NBSP_CHAR:h,ZERO_WIDTH_NBSP_CHAR:"\ufeff",blank:P,emptyPara:"<p>"+P+"</p>",makePredByNodeName:r,isEditable:t,isControlSizing:n,isText:i,isElement:o,isVoid:s,isPara:a,isPurePara:g,isHeading:u,isInline:b,isBlock:f.not(b),isBodyInline:S,isBody:A,isParaInline:O,isPre:l,isList:_,isTable:v,isData:y,isCell:E,isBlockquote:C,isBodyContainer:T,isAnchor:x,isDiv:r("DIV"),isLi:m,isBR:r("BR"),isSpan:r("SPAN"),isB:r("B"),isU:r("U"),isS:r("S"),isI:r("I"),isImg:r("IMG"),isTextarea:be,isEmpty:D,isEmptyAnchor:f.and(x,D),isClosestSibling:k,withClosestSiblings:R,nodeLength:N,isLeftEdgePoint:K,isRightEdgePoint:G,isEdgePoint:$,isLeftEdgeOf:Q,isRightEdgeOf:Y,isLeftEdgePointOf:X,isRightEdgePointOf:J,prevPoint:te,nextPoint:ne,isSamePoint:re,isVisiblePoint:ie,prevPointUntil:oe,nextPointUntil:se,isCharPoint:ae,walkPoint:ue,ancestor:j,singleChildAncestor:L,listAncestor:M,lastAncestor:F,listNext:U,listPrev:B,listDescendant:z,commonAncestor:H,wrap:q,insertAfter:W,appendChildNodes:V,position:Z,hasChildren:ee,makeOffsetPath:le,fromOffsetPath:ce,splitTree:pe,splitPoint:he,create:de,createText:me,remove:ge,removeWhile:ve,replace:ye,html:we,value:_e,posFromPlaceholder:Ee,attachEvents:Ce,detachEvents:Te,isCustomStyleTag:xe}}(),m=function(t,n){var r=this,i=e.summernote.ui
...
this.code(d.emptyPara),this._destroy(),this._initialize(),e&&r.disable()},this._initialize=function(){var t=e.extend({},this.options.buttons)
...
n?this.layoutInfo.codable.val(e):this.layoutInfo.editable.html(e),t.val(e),this.triggerEvent("change",e)},this.isDisabled=function(){return"false"===this.layoutInfo.editable.attr("contenteditable")},this.enable=function(){this.layoutInfo.editable.attr("contenteditable",!0),this.invoke("toolbar.activate",!0),this.triggerEvent("disable",!1)},this.disable=function(){this.invoke("codeview.isActivated")&&this.invoke("codeview.deactivate"),this.layoutInfo.editable.attr("contenteditable",!1),this.invoke("toolbar.deactivate",!0),this.triggerEvent("disable",!0)},this.triggerEvent=function(){var e=p.head(arguments),n=p.tail(p.from(arguments)),r=this.options.callbacks[f.namespaceToCamel(e,"on")]
r&&r.apply(t[0],n),t.trigger("summernote."+e,n)},this.initializeModule=function(e){var n=this.modules[e]
n.shouldInitialize=n.shouldInitialize||f.ok,n.shouldInitialize()&&(n.initialize&&n.initialize(),n.events&&d.attachEvents(t,n.events))},this.module=function(e,t,n){if(1===arguments.length)return this.modules[e]
this.modules[e]=new t(this),n||this.initializeModule(e)},this.removeModule=function(e){var n=this.modules[e]
n.shouldInitialize()&&(n.events&&d.detachEvents(t,n.events),n.destroy&&n.destroy()),delete this.modules[e]},this.memo=function(e,t){if(1===arguments.length)return this.memos[e]
...
var o=e(i.target)
r.invoke(t,n||o.closest("[data-value]").data("value"),o)}},this.invoke=function(){var e=p.head(arguments),t=p.tail(p.from(arguments)),n=e.split("."),r=n.length>1,i=r&&p.head(n),o=r?p.last(n):p.head(n),s=this.modules[i||"editor"]
return!i&&this[o]?this[o].apply(this,t):s&&s[o]&&s.shouldInitialize()?s[o].apply(s,t):void 0},this.initialize()}
e.fn.extend({summernote:function(){var t=e.type(p.head(arguments)),n="string"===t,r="object"===t,i=r?p.head(arguments):{}
i=e.extend({},e.summernote.options,i),i.langInfo=e.extend(!0,{},e.summernote.lang["en-US"],e.summernote.lang[i.lang]),i.icons=e.extend(!0,{},e.summernote.options.icons,i.icons),i.tooltip="auto"===i.tooltip?!c.isSupportTouch:i.tooltip,this.each(function(t,n){var r=e(n)
if(!r.data("summernote")){var o=new m(r,i)
r.data("summernote",o),r.data("summernote").triggerEvent("init",o.layoutInfo)}})
var o=this.first()
if(o.length){var s=o.data("summernote")
if(n)return s.invoke.apply(s,p.from(arguments))
i.focus&&s.invoke("editor.focus")}return this}})
var g=function(t,n,r,i){this.render=function(o){var s=e(t)
...
n.forEach(function(e){e.render(a.length?a:s)})}return i&&i(s,r),r&&r.callback&&r.callback(s),o&&o.append(s),s}},v={create:function(t,n){return function(){var r=e.isArray(arguments[0])?arguments[0]:[],i="object"==typeof arguments[1]?arguments[1]:arguments[0]
return i&&i.children&&(r=i.children),new g(t,r,i,n)}}},y=v.create('<div class="note-editor note-frame card"/>'),b=v.create('<div class="note-toolbar card-header"/>'),_=v.create('<div class="note-editing-area"/>'),w=v.create('<textarea class="note-codable"/>'),E=v.create('<div class="note-editable card-block" contentEditable="true"/>'),C=v.create(['<div class="note-statusbar">','  <div class="note-resizebar">','    <div class="note-icon-bar"/>','    <div class="note-icon-bar"/>','    <div class="note-icon-bar"/>',"  </div>","</div>"].join("")),T=v.create('<div class="note-editor"/>'),x=v.create('<div class="note-editable" contentEditable="true"/>'),O=v.create('<div class="note-btn-group btn-group">'),S=v.create('<div class="dropdown-menu">',function(t,n){var r=e.isArray(n.items)?n.items.map(function(e){var t="string"==typeof e?e:e.value||"",r=n.template?n.template(e):e,i="object"==typeof e?e.option:void 0
return'<a class="dropdown-item" href="#" data-value="'+t+'"'+(void 0!==i?' data-option="'+i+'"':"")+">"+r+"</a>"}).join(""):n.items
t.html(r)}),A=function(e){return e},k=v.create('<div class="dropdown-menu note-check">',function(t,n){var r=e.isArray(n.items)?n.items.map(function(e){var t="string"==typeof e?e:e.value||"",r=n.template?n.template(e):e
return'<a class="dropdown-item" href="#" data-value="'+t+'">'+I(n.checkClassName)+" "+r+"</a>"}).join(""):n.items
t.html(r)}),R=v.create('<div class="note-color-palette"/>',function(e,t){for(var n=[],r=0,i=t.colors.length;r<i;r++){for(var o=t.eventName,s=t.colors[r],a=[],u=0,l=s.length;u<l;u++){var c=s[u]
a.push(['<button type="button" class="note-color-btn"','style="background-color:',c,'" ','data-event="',o,'" ','data-value="',c,'" ','title="',c,'" ','data-toggle="button" tabindex="-1"></button>'].join(""))}n.push('<div class="note-color-row">'+a.join("")+"</div>")}e.html(n.join("")),t.tooltip&&e.find(".note-color-btn").tooltip({container:"body",trigger:"hover",placement:"bottom"})}),P=v.create('<div class="modal" aria-hidden="false" tabindex="-1"/>',function(e,t){t.fade&&e.addClass("fade"),e.html(['<div class="modal-dialog">','  <div class="modal-content">',t.title?'    <div class="modal-header">      <h4 class="modal-title">'+t.title+'</h4>      <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>    </div>':"",'    <div class="modal-body">'+t.body+"</div>",t.footer?'    <div class="modal-footer">'+t.footer+"</div>":"","  </div>","</div>"].join(""))}),N=v.create(['<div class="note-popover popover in">','  <div class="arrow"/>','  <div class="popover-content note-children-container"/>',"</div>"].join(""),function(e,t){var n=void 0!==t.direction?t.direction:"bottom"
e.addClass(n),t.hideArrow&&e.find(".arrow").hide()}),D=v.create('<label class="custom-control custom-checkbox"></label>',function(e,t){t.id&&e.attr("for",t.id),e.html([' <input type="checkbox" class="custom-control-input"'+(t.id?' id="'+t.id+'"':""),(t.checked?" checked":"")+"/>",' <span class="custom-control-indicator"></span>',' <span class="custom-control-description">'+(t.text?t.text:"")+"</span>","</label>"].join(""))}),I=function(e,t){return"<"+(t=t||"i")+' class="'+e+'"/>'},j={editor:y,toolbar:b,editingArea:_,codable:w,editable:E,statusbar:C,airEditor:T,airEditable:x,buttonGroup:O,dropdown:S,dropdownButtonContents:A,dropdownCheck:k,palette:R,dialog:P,popover:N,icon:I,checkbox:D,options:{},button:function(e,t){return v.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1">',function(e,t){t&&t.tooltip&&self.options.tooltip&&e.attr({title:t.tooltip}).tooltip({container:"body",trigger:"hover",placement:"bottom"})})(e,t)},toggleBtn:function(e,t){e.toggleClass("disabled",!t),e.attr("disabled",!t)},toggleBtnActive:function(e,t){e.toggleClass("active",t)},onDialogShown:function(e,t){e.one("shown.bs.modal",t)},onDialogHidden:function(e,t){e.one("hidden.bs.modal",t)},showDialog:function(e){e.modal("show")},hideDialog:function(e){e.modal("hide")},createLayout:function(e,t){self.options=t
var n=(t.airMode?j.airEditor([j.editingArea([j.airEditable()])]):j.editor([j.toolbar(),j.editingArea([j.codable(),j.editable()]),j.statusbar()])).render()
...
var L=function(){var e={BACKSPACE:8,TAB:9,ENTER:13,SPACE:32,DELETE:46,LEFT:37,UP:38,RIGHT:39,DOWN:40,NUM0:48,NUM1:49,NUM2:50,NUM3:51,NUM4:52,NUM5:53,NUM6:54,NUM7:55,NUM8:56,B:66,E:69,I:73,J:74,K:75,L:76,R:82,S:83,U:85,V:86,Y:89,Z:90,SLASH:191,LEFTBRACKET:219,BACKSLASH:220,RIGHTBRACKET:221}
return{isEdit:function(t){return p.contains([e.BACKSPACE,e.TAB,e.ENTER,e.SPACE,e.DELETE],t)},isMove:function(t){return p.contains([e.LEFT,e.UP,e.RIGHT,e.DOWN],t)},nameFromCode:f.invertObject(e),code:e}}(),M=function(){var t=function(e,t){var n,r,i=e.parentElement(),o=document.body.createTextRange(),s=p.from(i.childNodes)
for(n=0;n<s.length;n++)if(!d.isText(s[n])){if(o.moveToElementText(s[n]),o.compareEndPoints("StartToStart",e)>=0)break
r=s[n]}if(0!==n&&d.isText(s[n-1])){var a=document.body.createTextRange(),u=null
...
u.nodeValue
t&&u.nextSibling&&d.isText(u.nextSibling)&&c===u.nodeValue.length&&(c-=u.nodeValue.length,u=u.nextSibling),i=u,n=c}return{cont:i,offset:n}},n=function(e){var t=function(e,n){var r,i
if(d.isText(e)){var o=d.listPrev(e,f.not(d.isText)),s=p.last(o).previousSibling
r=s||e.parentNode,n+=p.sum(p.tail(o),d.nodeLength),i=!s}else{if(r=e.childNodes[n]||e,d.isText(r))return t(r,0)
...
var a=function(){if(c.isW3CRangeSupport){var e=document.createRange()
...
if(c.isW3CRangeSupport){var t=document.getSelection()
t.rangeCount>0&&t.removeAllRanges(),t.addRange(e)}else e.select()
return this},this.scrollIntoView=function(t){var n=e(t).height()
return t.scrollTop+n<this.sc.offsetTop&&(t.scrollTop+=Math.abs(t.scrollTop+n-this.sc.offsetTop)),this},this.normalize=function(){var e=function(e,t){if(d.isVisiblePoint(e)&&!d.isEdgePoint(e)||d.isVisiblePoint(e)&&d.isRightEdgePoint(e)&&!t||d.isVisiblePoint(e)&&d.isLeftEdgePoint(e)&&t||d.isVisiblePoint(e)&&d.isBlock(e.node)&&d.isEmpty(e.node))return e
var n=d.ancestor(e.node,d.isBlock)
if((d.isLeftEdgePointOf(e,n)||d.isVoid(d.prevPoint(e).node))&&!t||(d.isRightEdgePointOf(e,n)||d.isVoid(d.nextPoint(e).node))&&t){if(d.isVisiblePoint(e))return e
t=!t}return(t?d.nextPointUntil(d.nextPoint(e),d.isVisiblePoint):d.prevPointUntil(d.prevPoint(e),d.isVisiblePoint))||e},t=e(this.getEndPoint(),!1),n=this.isCollapsed()?t:e(this.getStartPoint(),!0)
return new r(n.node,n.offset,t.node,t.offset)},this.nodes=function(e,t){e=e||f.ok
var n=t&&t.includeAncestor,r=t&&t.fullyContains,i=this.getStartPoint(),o=this.getEndPoint(),s=[],a=[]
return d.walkPoint(i,o,function(t){if(!d.isEditable(t.node)){var i
r?(d.isLeftEdgePoint(t)&&a.push(t.node),d.isRightEdgePoint(t)&&p.contains(a,t.node)&&(i=t.node)):i=n?d.ancestor(t.node,e):t.node,i&&e(i)&&s.push(i)}},!0),p.unique(s)},this.commonAncestor=function(){return d.commonAncestor(t,o)},this.expand=function(e){var n=d.ancestor(t,e),a=d.ancestor(o,e)
if(!n&&!a)return new r(t,i,o,s)
var u=this.getPoints()
return n&&(u.sc=n,u.so=0),a&&(u.ec=a,u.eo=d.nodeLength(a)),new r(u.sc,u.so,u.ec,u.eo)},this.collapse=function(e){return e?new r(t,i,t,i):new r(o,s,o,s)},this.splitText=function(){var e=t===o,n=this.getPoints()
return d.isText(o)&&!d.isEdgePoint(this.getEndPoint())&&o.splitText(s),d.isText(t)&&!d.isEdgePoint(this.getStartPoint())&&(n.sc=t.splitText(i),n.so=0,e&&(n.ec=n.sc,n.eo=s-i)),new r(n.sc,n.so,n.ec,n.eo)},this.deleteContents=function(){if(this.isCollapsed())return this
var t=this.splitText(),n=t.nodes(null,{fullyContains:!0}),i=d.prevPointUntil(t.getStartPoint(),function(e){return!p.contains(n,e.node)}),o=[]
return e.each(n,function(e,t){var n=t.parentNode
i.node!==n&&1===d.nodeLength(n)&&o.push(n),d.remove(t,!1)}),e.each(o,function(e,t){d.remove(t,!1)}),new r(i.node,i.offset,i.node,i.offset).normalize()}
var u=function(e){return function(){var n=d.ancestor(t,e)
return!!n&&n===d.ancestor(o,e)}}
this.isOnEditable=u(d.isEditable),this.isOnList=u(d.isList),this.isOnAnchor=u(d.isAnchor),this.isOnCell=u(d.isCell),this.isOnData=u(d.isData),this.isLeftEdgeOf=function(e){if(!d.isLeftEdgePoint(this.getStartPoint()))return!1
var t=d.ancestor(this.sc,e)
return t&&d.isLeftEdgeOf(this.sc,t)},this.isCollapsed=function(){return t===o&&i===s},this.wrapBodyInlineWithPara=function(){if(d.isBodyContainer(t)&&d.isEmpty(t))return t.innerHTML=d.emptyPara,new r(t.firstChild,0,t.firstChild,0)
var e=this.normalize()
if(d.isParaInline(t)||d.isPara(t))return e
var n
if(d.isInline(e.sc)){var i=d.listAncestor(e.sc,f.not(d.isInline))
n=p.last(i),d.isInline(n)||(n=i[i.length-2]||e.sc.childNodes[e.so])}else n=e.sc.childNodes[e.so>0?e.so-1:0]
var o=d.listPrev(n,d.isParaInline).reverse()
if(o=o.concat(d.listNext(n.nextSibling,d.isParaInline)),o.length){var s=d.wrap(p.head(o),"p")
d.appendChildNodes(s,p.tail(o))}return this.normalize()},this.insertNode=function(e){var t=this.wrapBodyInlineWithPara().deleteContents(),n=d.splitPoint(t.getStartPoint(),d.isInline(e))
return n.rightNode?n.rightNode.parentNode.insertBefore(e,n.rightNode):n.container.appendChild(e),e},this.pasteHTML=function(t){var n=e("<div></div>").html(t)[0],r=p.from(n.childNodes),i=this.wrapBodyInlineWithPara().deleteContents()
return r.reverse().map(function(e){return i.insertNode(e)}).reverse()},this.toString=function(){var e=a()
return c.isW3CRangeSupport?e.toString():e.text},this.getWordRange=function(e){var t=this.getEndPoint()
if(!d.isCharPoint(t))return this
var n=d.prevPointUntil(t,function(e){return!d.isCharPoint(e)})
return e&&(t=d.nextPointUntil(t,function(e){return!d.isCharPoint(e)})),new r(n.node,n.offset,t.node,t.offset)},this.bookmark=function(e){return{s:{path:d.makeOffsetPath(e,t),offset:i},e:{path:d.makeOffsetPath(e,o),offset:s}}},this.paraBookmark=function(e){return{s:{path:p.tail(d.makeOffsetPath(p.head(e),t)),offset:i},e:{path:p.tail(d.makeOffsetPath(p.last(e),o)),offset:s}}},this.getClientRects=function(){return a().getClientRects()}}
...
return o||1!==arguments.length?o:(o=this.createFromNode(arguments[0]),o.collapse(d.emptyPara===arguments[0].innerHTML))},createFromSelection:function(){var e,n,i,o
if(c.isW3CRangeSupport){var s=document.getSelection()
if(!s||0===s.rangeCount)return null
if(d.isBody(s.anchorNode))return null
var a=s.getRangeAt(0)
e=a.startContainer,n=a.startOffset,i=a.endContainer,o=a.endOffset}else{var u=document.selection.createRange(),l=u.duplicate()
l.collapse(!1)
var f=u
f.collapse(!0)
var p=t(f,!0),h=t(l,!1)
d.isText(p.node)&&d.isLeftEdgePoint(p)&&d.isTextNode(h.node)&&d.isRightEdgePoint(h)&&h.node.nextSibling===p.node&&(p=h),e=p.cont,n=p.offset,i=h.cont,o=h.offset}return new r(e,n,i,o)},createFromNode:function(e){var t=e,n=0,r=e,i=d.nodeLength(r)
return d.isVoid(t)&&(n=d.listPrev(t).length-1,t=t.parentNode),d.isBR(r)?(i=d.listPrev(r).length-1,r=r.parentNode):d.isVoid(r)&&(i=d.listPrev(r).length,r=r.parentNode),this.create(t,n,r,i)},createFromNodeBefore:function(e){return this.createFromNode(e).collapse(!0)},createFromNodeAfter:function(e){return this.createFromNode(e).collapse()},createFromBookmark:function(e,t){var n=d.fromOffsetPath(e,t.s.path),i=t.s.offset,o=d.fromOffsetPath(e,t.e.path),s=t.e.offset
return new r(n,i,o,s)},createFromParaBookmark:function(e,t){var n=e.s.offset,i=e.e.offset,o=d.fromOffsetPath(p.head(t),e.s.path),s=d.fromOffsetPath(p.last(t),e.e.path)
return new r(o,n,s,i)}}}(),F=function(){return{readFileAsDataURL:function(t){return e.Deferred(function(n){e.extend(new FileReader,{onload:function(e){var t=e.target.result
...
r.one("load",function(){r.off("error abort"),n.resolve(r)}).one("error abort",function(){r.off("load").detach(),n.reject(r)}).css({display:"none"}).appendTo(document.body).attr("src",t)}).promise()}}}(),H=function(e){var t=[],n=-1,r=e[0],i=function(){var t=M.create(r),n={s:{path:[],offset:0},e:{path:[],offset:0}}
return{contents:e.html(),bookmark:t?t.bookmark(r):n}},o=function(t){null!==t.contents&&e.html(t.contents),null!==t.bookmark&&M.createFromBookmark(r,t.bookmark).select()}
this.rewind=function(){e.html()!==t[n].contents&&this.recordUndo(),n=0,o(t[n])},this.reset=function(){t=[],n=-1,e.html(""),this.recordUndo()},this.undo=function(){e.html()!==t[n].contents&&this.recordUndo(),0<n&&(n--,o(t[n]))},this.redo=function(){t.length-1>n&&(n++,o(t[n]))},this.recordUndo=function(){n++,t.length>n&&(t=t.slice(0,n)),t.push(i())}},B=function(){var t=function(t,n){if(c.jqueryVersion<1.9){var r={}
return e.each(n,function(e,n){r[n]=t.css(n)}),r}return t.css.call(t,n)}
this.fromNode=function(e){var n=["font-family","font-size","text-align","list-style-type","line-height"],r=t(e,n)||{}
return r["font-size"]=parseInt(r["font-size"],10),r},this.stylePara=function(t,n){e.each(t.nodes(d.isPara,{includeAncestor:!0}),function(t,r){e(r).css(n)})},this.styleNodes=function(t,n){t=t.splitText()
var r=n&&n.nodeName||"SPAN",i=!(!n||!n.expandClosestSibling),o=!(!n||!n.onlyPartialContains)
if(t.isCollapsed())return[t.insertNode(d.create(r))]
var s=d.makePredByNodeName(r),a=t.nodes(d.isText,{fullyContains:!0}).map(function(e){return d.singleChildAncestor(e,s)||d.wrap(e,r)})
if(i){if(o){var u=t.nodes()
s=f.and(s,function(e){return p.contains(u,e)})}return a.map(function(t){var n=d.withClosestSiblings(t,s),r=p.head(n),i=p.tail(n)
return e.each(i,function(e,t){d.appendChildNodes(r,t.childNodes),d.remove(t)}),p.head(n)})}return a},this.current=function(t){var n=e(d.isElement(t.sc)?t.sc:t.sc.parentNode),r=this.fromNode(n)
...
var s=d.ancestor(t.sc,d.isPara)
if(s&&s.style["line-height"])r["line-height"]=s.style.lineHeight
else{var a=parseInt(r["line-height"],10)/parseInt(r["font-size"],10)
r["line-height"]=a.toFixed(1)}return r.anchor=t.isOnAnchor()&&d.ancestor(t.sc,d.isAnchor),r.ancestors=d.listAncestor(t.sc,d.isEditable),r.range=t,r}},U=function(){var t=this
this.insertOrderedList=function(e){this.toggleList("OL",e)},this.insertUnorderedList=function(e){this.toggleList("UL",e)},this.indent=function(t){var n=this,r=M.create(t).wrapBodyInlineWithPara(),i=r.nodes(d.isPara,{includeAncestor:!0}),o=p.clusterBy(i,f.peq2("parentNode"))
e.each(o,function(t,r){var i=p.head(r)
d.isLi(i)?n.wrapList(r,i.parentNode.nodeName):e.each(r,function(t,n){e(n).css("marginLeft",function(e,t){return(parseInt(t,10)||0)+25})})}),r.select()},this.outdent=function(t){var n=this,r=M.create(t).wrapBodyInlineWithPara(),i=r.nodes(d.isPara,{includeAncestor:!0}),o=p.clusterBy(i,f.peq2("parentNode"))
e.each(o,function(t,r){var i=p.head(r)
d.isLi(i)?n.releaseList([r]):e.each(r,function(t,n){e(n).css("marginLeft",function(e,t){return t=parseInt(t,10)||0,t>25?t-25:""})})}),r.select()},this.toggleList=function(n,r){var i=M.create(r).wrapBodyInlineWithPara(),o=i.nodes(d.isPara,{includeAncestor:!0}),s=i.paraBookmark(o),a=p.clusterBy(o,f.peq2("parentNode"))
if(p.find(o,d.isPurePara)){var u=[]
e.each(a,function(e,r){u=u.concat(t.wrapList(r,n))}),o=u}else{var l=i.nodes(d.isList,{includeAncestor:!0}).filter(function(t){return!e.nodeName(t,n)})
l.length?e.each(l,function(e,t){d.replace(t,n)}):o=this.releaseList(a,!0)}M.createFromParaBookmark(s,o).select()},this.wrapList=function(e,t){var n=p.head(e),r=p.last(e),i=d.isList(n.previousSibling)&&n.previousSibling,o=d.isList(r.nextSibling)&&r.nextSibling,s=i||d.insertAfter(d.create(t||"UL"),r)
return e=e.map(function(e){return d.isPurePara(e)?d.replace(e,"LI"):e}),d.appendChildNodes(s,e),o&&(d.appendChildNodes(s,p.from(o.childNodes)),d.remove(o)),e},this.releaseList=function(t,n){var r=[]
return e.each(t,function(t,i){var o=p.head(i),s=p.last(i),a=n?d.lastAncestor(o,d.isList):o.parentNode,u=a.childNodes.length>1?d.splitTree(a,{node:s.parentNode,offset:d.position(s)+1},{isSkipPaddingBlankHTML:!0}):null,l=d.splitTree(a,{node:o.parentNode,offset:d.position(o)},{isSkipPaddingBlankHTML:!0})
i=n?d.listDescendant(l,d.isLi):p.from(l.childNodes).filter(d.isLi),!n&&d.isList(a.parentNode)||(i=i.map(function(e){return d.replace(e,"P")})),e.each(p.from(i).reverse(),function(e,t){d.insertAfter(t,a)})
var c=p.compact([a,l,u])
e.each(c,function(t,n){var r=[n].concat(d.listDescendant(n,d.isList))
e.each(r.reverse(),function(e,t){d.nodeLength(t)||d.remove(t,!0)})}),r=r.concat(i)}),r}},z=function(){var t=new U
this.insertTab=function(e,t){var n=d.createText(new Array(t+1).join(d.NBSP_CHAR))
e=e.deleteContents(),e.insertNode(n,!0),e=M.create(n,t),e.select()},this.insertParagraph=function(n){var r=M.create(n)
r=r.deleteContents(),r=r.wrapBodyInlineWithPara()
var i,o=d.ancestor(r.sc,d.isPara)
if(o){if(d.isEmpty(o)&&d.isLi(o))return void t.toggleList(o.parentNode.nodeName)
if(d.isEmpty(o)&&d.isPara(o)&&d.isBlockquote(o.parentNode))d.insertAfter(o,o.parentNode),i=o
else{i=d.splitTree(o,r.getStartPoint())
var s=d.listDescendant(o,d.isEmptyAnchor)
s=s.concat(d.listDescendant(i,d.isEmptyAnchor)),e.each(s,function(e,t){d.remove(t)}),(d.isHeading(i)||d.isPre(i)||d.isCustomStyleTag(i))&&d.isEmpty(i)&&(i=d.replace(i,"p"))}}else{var a=r.sc.childNodes[r.so]
i=e(d.emptyPara)[0],a?r.sc.insertBefore(i,a):r.sc.appendChild(i)}M.create(i,0).normalize().select().scrollIntoView(n)}},q=function(e,t,n,r){function i(){return!e||!e.tagName||"td"!==e.tagName.toLowerCase()&&"th"!==e.tagName.toLowerCase()?void console.error("Impossible to identify start Cell point.",e):(h.colPos=e.cellIndex,e.parentElement&&e.parentElement.tagName&&"tr"===e.parentElement.tagName.toLowerCase()?void(h.rowPos=e.parentElement.rowIndex):void console.error("Impossible to identify start Row point.",e))}function o(e,t,n,r,i,o,s){var a={baseRow:n,baseCell:r,isRowSpan:i,isColSpan:o,isVirtual:s}
...
l(e.rowIndex,m,t,s),o(e.rowIndex,m,e,t,i,!0,!0)}}function l(e,t,n,r){e===h.rowPos&&h.colPos>=n.cellIndex&&n.cellIndex<=t&&!r&&h.colPos++}function c(){for(var e=r.rows,t=0;t<e.length;t++)for(var n=e[t].cells,i=0;i<n.length;i++)u(e[t],n[i])}function f(e){switch(t){case q.where.Column:if(e.isColSpan)return q.resultAction.SubtractSpanCount
break
case q.where.Row:if(!e.isVirtual&&e.isRowSpan)return q.resultAction.AddCell
if(e.isRowSpan)return q.resultAction.SubtractSpanCount}return q.resultAction.RemoveCell}function p(e){switch(t){case q.where.Column:if(e.isColSpan)return q.resultAction.SumSpanCount
if(e.isRowSpan&&e.isVirtual)return q.resultAction.Ignore
break
case q.where.Row:if(e.isRowSpan)return q.resultAction.SumSpanCount
if(e.isColSpan&&e.isVirtual)return q.resultAction.Ignore}return q.resultAction.AddCell}var h={colPos:0,rowPos:0},d=[],m=[]
this.getActionList=function(){for(var e=t===q.where.Row?h.rowPos:-1,r=t===q.where.Column?h.colPos:-1,i=0,o=!0;o;){var a=e>=0?e:i,u=r>=0?r:i,l=d[a]
if(!l)return o=!1,m
var c=l[u]
if(!c)return o=!1,m
var g=q.resultAction.Ignore
switch(n){case q.requestAction.Add:g=p(c)
break
case q.requestAction.Delete:g=f(c)}m.push(s(c,g,a,u)),i++}return m},function(){i(),c()}()}
q.where={Row:0,Column:1},q.requestAction={Add:0,Delete:1},q.resultAction={Ignore:0,SubtractSpanCount:1,RemoveCell:2,AddCell:3,SumSpanCount:4}
var W,V=function(){this.tab=function(e,t){var n=d.ancestor(e.commonAncestor(),d.isCell),r=d.ancestor(n,d.isTable),i=d.listDescendant(r,d.isCell),o=p[t?"prev":"next"](i,n)
o&&M.create(o,0).select()},this.addRow=function(t,n){for(var r=d.ancestor(t.commonAncestor(),d.isCell),i=e(r).closest("tr"),o=this.recoverAttributes(i),s=e("<tr"+o+"></tr>"),a=new q(r,q.where.Row,q.requestAction.Add,e(i).closest("table")[0]),u=a.getActionList(),l=0;l<u.length;l++){var c=u[l],f=this.recoverAttributes(c.baseCell)
switch(c.action){case q.resultAction.AddCell:s.append("<td"+f+">"+d.blank+"</td>")
break
case q.resultAction.SumSpanCount:if("top"===n){if((c.baseCell.parent?c.baseCell.closest("tr").rowIndex:0)<=i[0].rowIndex){var p=e("<div></div>").append(e("<td"+f+">"+d.blank+"</td>").removeAttr("rowspan")).html()
s.append(p)
break}}var h=parseInt(c.baseCell.rowSpan,10)
h++,c.baseCell.setAttribute("rowSpan",h)}}if("top"===n)i.before(s)
else{if(r.rowSpan>1){var m=i[0].rowIndex+(r.rowSpan-2)
return void e(e(i).parent().find("tr")[m]).after(e(s))}i.after(s)}},this.addCol=function(t,n){var r=d.ancestor(t.commonAncestor(),d.isCell),i=e(r).closest("tr")
e(i).siblings().push(i)
for(var o=new q(r,q.where.Column,q.requestAction.Add,e(i).closest("table")[0]),s=o.getActionList(),a=0;a<s.length;a++){var u=s[a],l=this.recoverAttributes(u.baseCell)
switch(u.action){case q.resultAction.AddCell:"right"===n?e(u.baseCell).after("<td"+l+">"+d.blank+"</td>"):e(u.baseCell).before("<td"+l+">"+d.blank+"</td>")
break
case q.resultAction.SumSpanCount:if("right"===n){var c=parseInt(u.baseCell.colSpan,10)
c++,u.baseCell.setAttribute("colSpan",c)}else e(u.baseCell).before("<td"+l+">"+d.blank+"</td>")}}},this.recoverAttributes=function(e){var t=""
if(!e)return t
for(var n=e.attributes||[],r=0;r<n.length;r++)"id"!==n[r].name.toLowerCase()&&n[r].specified&&(t+=" "+n[r].name+"='"+n[r].value+"'")
return t},this.deleteRow=function(t){for(var n=d.ancestor(t.commonAncestor(),d.isCell),r=e(n).closest("tr"),i=r.children("td, th").index(e(n)),o=r[0].rowIndex,s=new q(n,q.where.Row,q.requestAction.Delete,e(r).closest("table")[0]),a=s.getActionList(),u=0;u<a.length;u++)if(a[u]){var l=a[u].baseCell,c=a[u].virtualTable,f=l.rowSpan&&l.rowSpan>1,p=f?parseInt(l.rowSpan,10):0
switch(a[u].action){case q.resultAction.Ignore:continue
case q.resultAction.AddCell:var h=r.next("tr")[0]
if(!h)continue
var m=r[0].cells[i]
f&&(p>2?(p--,h.insertBefore(m,h.cells[i]),h.cells[i].setAttribute("rowSpan",p),h.cells[i].innerHTML=""):2===p&&(h.insertBefore(m,h.cells[i]),h.cells[i].removeAttribute("rowSpan"),h.cells[i].innerHTML=""))
continue
case q.resultAction.SubtractSpanCount:f&&(p>2?(p--,l.setAttribute("rowSpan",p),c.rowIndex!==o&&l.cellIndex===i&&(l.innerHTML="")):2===p&&(l.removeAttribute("rowSpan"),c.rowIndex!==o&&l.cellIndex===i&&(l.innerHTML="")))
continue
case q.resultAction.RemoveCell:continue}}r.remove()},this.deleteCol=function(t){for(var n=d.ancestor(t.commonAncestor(),d.isCell),r=e(n).closest("tr"),i=r.children("td, th").index(e(n)),o=new q(n,q.where.Column,q.requestAction.Delete,e(r).closest("table")[0]),s=o.getActionList(),a=0;a<s.length;a++)if(s[a])switch(s[a].action){case q.resultAction.Ignore:continue
case q.resultAction.SubtractSpanCount:var u=s[a].baseCell,l=u.colSpan&&u.colSpan>1
if(l){var c=u.colSpan?parseInt(u.colSpan,10):0
c>2?(c--,u.setAttribute("colSpan",c),u.cellIndex===i&&(u.innerHTML="")):2===c&&(u.removeAttribute("colSpan"),u.cellIndex===i&&(u.innerHTML=""))}continue
case q.resultAction.RemoveCell:d.remove(s[a].baseCell,!0)
continue}},this.createTable=function(t,n,r){for(var i,o=[],s=0;s<t;s++)o.push("<td>"+d.blank+"</td>")
i=o.join("")
for(var a,u=[],l=0;l<n;l++)u.push("<tr>"+i+"</tr>")
a=u.join("")
var c=e("<table>"+a+"</table>")
return r&&r.tableClassName&&c.addClass(r.tableClassName),c[0]},this.deleteTable=function(t){var n=d.ancestor(t.commonAncestor(),d.isCell)
e(n).closest("table").remove()}},K=function(t){var n=this,r=t.layoutInfo.note,i=t.layoutInfo.editor,o=t.layoutInfo.editable,s=t.options,a=s.langInfo,u=o[0],l=null,h=new B,m=new V,g=new z,v=new U,y=new H(o)
this.initialize=function(){o.on("keydown",function(e){e.keyCode===L.code.ENTER&&t.triggerEvent("enter",e),t.triggerEvent("keydown",e),e.isDefaultPrevented()||(s.shortcuts?n.handleKeyMap(e):n.preventDefaultEditableShortCuts(e))}).on("keyup",function(e){t.triggerEvent("keyup",e)}).on("focus",function(e){t.triggerEvent("focus",e)}).on("blur",function(e){t.triggerEvent("blur",e)}).on("mousedown",function(e){t.triggerEvent("mousedown",e)}).on("mouseup",function(e){t.triggerEvent("mouseup",e)}).on("scroll",function(e){t.triggerEvent("scroll",e)}).on("paste",function(e){t.triggerEvent("paste",e)}),o.html(d.html(r)||d.emptyPara)
var e=c.isMSIE?"DOMCharacterDataModified DOMSubtreeModified DOMNodeInserted":"input"
o.on(e,f.debounce(function(){t.triggerEvent("change",o.html())},100)),i.on("focusin",function(e){t.triggerEvent("focusin",e)}).on("focusout",function(e){t.triggerEvent("focusout",e)}),s.airMode||(s.width&&i.outerWidth(s.width),s.height&&o.outerHeight(s.height),s.maxHeight&&o.css("max-height",s.maxHeight),s.minHeight&&o.css("min-height",s.minHeight)),y.recordUndo()},this.destroy=function(){o.off()},this.handleKeyMap=function(e){var n=s.keyMap[c.isMac?"mac":"pc"],r=[]
e.metaKey&&r.push("CMD"),e.ctrlKey&&!e.altKey&&r.push("CTRL"),e.shiftKey&&r.push("SHIFT")
var i=L.nameFromCode[e.keyCode]
i&&r.push(i)
var o=n[r.join("+")]
o?(e.preventDefault(),t.invoke(o)):L.isEdit(e.keyCode)&&this.afterCommand()},this.preventDefaultEditableShortCuts=function(e){(e.ctrlKey||e.metaKey)&&p.contains([66,73,85],e.keyCode)&&e.preventDefault()},this.createRange=function(){return this.focus(),M.create(u)},this.saveRange=function(e){l=this.createRange(),e&&l.collapse().select()},this.restoreRange=function(){l&&(l.select(),this.focus())},this.saveTarget=function(e){o.data("target",e)},this.clearTarget=function(){o.removeData("target")},this.restoreTarget=function(){return o.data("target")},this.currentStyle=function(){var e=M.create()
return e&&(e=e.normalize()),e?h.current(e):h.fromNode(o)},this.styleFromNode=function(e){return h.fromNode(e)},this.undo=function(){t.triggerEvent("before.command",o.html()),y.undo(),t.triggerEvent("change",o.html())},t.memo("help.undo",a.help.undo),this.redo=function(){t.triggerEvent("before.command",o.html()),y.redo(),t.triggerEvent("change",o.html())},t.memo("help.redo",a.help.redo)
...
e.isCollapsed()&&e.isOnCell()&&m.tab(e,!0)},t.memo("help.untab",a.help.untab),this.wrapCommand=function(e){return function(){b(),e.apply(n,arguments),_()}},this.insertParagraph=this.wrapCommand(function(){g.insertParagraph(u)}),t.memo("help.insertParagraph",a.help.insertParagraph),this.insertOrderedList=this.wrapCommand(function(){v.insertOrderedList(u)}),t.memo("help.insertOrderedList",a.help.insertOrderedList),this.insertUnorderedList=this.wrapCommand(function(){v.insertUnorderedList(u)}),t.memo("help.insertUnorderedList",a.help.insertUnorderedList),this.indent=this.wrapCommand(function(){v.indent(u)}),t.memo("help.indent",a.help.indent),this.outdent=this.wrapCommand(function(){v.outdent(u)}),t.memo("help.outdent",a.help.outdent),this.insertImage=function(e,n){return F.createImage(e,n).then(function(e){b(),"function"==typeof n?n(e):("string"==typeof n&&e.attr("data-filename",n),e.css("width",Math.min(o.width(),e.width()))),e.show(),M.create(u).insertNode(e[0]),M.createFromNodeAfter(e[0]).select(),_()}).fail(function(e){t.triggerEvent("image.upload.error",e)})},this.insertImages=function(r){e.each(r,function(e,r){var i=r.name
s.maximumImageFileSize&&s.maximumImageFileSize<r.size?t.triggerEvent("image.upload.error",a.image.maximumFileSizeError):F.readFileAsDataURL(r).then(function(e){return n.insertImage(e,i)}).fail(function(){t.triggerEvent("image.upload.error")})})},this.insertImagesOrCallback=function(e){s.callbacks.onImageUpload?t.triggerEvent("image.upload",e):this.insertImages(e)},this.insertNode=this.wrapCommand(function(e){this.createRange().insertNode(e),M.createFromNodeAfter(e).select()}),this.insertText=this.wrapCommand(function(e){var t=this.createRange(),n=t.insertNode(d.createText(e))
M.create(n,d.nodeLength(n)).select()}),this.getSelectedText=function(){var e=this.createRange()
return e.isOnAnchor()&&(e=M.createFromNode(d.ancestor(e.sc,d.isAnchor))),e.toString()},this.pasteHTML=this.wrapCommand(function(e){var t=this.createRange().pasteHTML(e)
M.createFromNodeAfter(p.last(t)).select()}),this.formatBlock=this.wrapCommand(function(e,n){var r=t.options.callbacks.onApplyCustomStyle
r?r.call(this,n,t,this.onFormatBlock):this.onFormatBlock(e)}),this.onFormatBlock=function(e){e=c.isMSIE?"<"+e+">":e,document.execCommand("FormatBlock",!1,e)},this.formatPara=function(){this.formatBlock("P")},t.memo("help.formatPara",a.help.formatPara)
for(var E=1;E<=6;E++)this["formatH"+E]=function(e){return function(){this.formatBlock("H"+e)}}(E),t.memo("help.formatH"+E,a.help["formatH"+E])
this.fontSize=function(t){var n=this.createRange()
if(n&&n.isCollapsed()){var r=h.styleNodes(n),i=p.head(r)
e(r).css({"font-size":t+"px"}),i&&!d.nodeLength(i)&&(i.innerHTML=d.ZERO_WIDTH_NBSP_CHAR,M.createFromNodeAfter(i.firstChild).select(),o.data("bogus",i))}else b(),e(h.styleNodes(n)).css({"font-size":t+"px"}),_()},this.insertHorizontalRule=this.wrapCommand(function(){var e=this.createRange().insertNode(d.create("HR"))
e.nextSibling&&M.create(e.nextSibling,0).normalize().select()}),t.memo("help.insertHorizontalRule",a.help.insertHorizontalRule),this.removeBogus=function(){var e=o.data("bogus")
if(e){var t=p.find(p.from(e.childNodes),d.isText),n=t.nodeValue.indexOf(d.ZERO_WIDTH_NBSP_CHAR);-1!==n&&t.deleteData(n,1),d.isEmpty(e)&&d.remove(e),o.removeData("bogus")}},this.lineHeight=this.wrapCommand(function(e){h.stylePara(this.createRange(),{lineHeight:e})}),this.unlink=function(){var e=this.createRange()
if(e.isOnAnchor()){var t=d.ancestor(e.sc,d.isAnchor)
e=M.createFromNode(t),e.select(),b(),document.execCommand("unlink"),_()}},this.createLink=this.wrapCommand(function(t){var n=t.url,r=t.text,i=t.isNewWindow,o=t.range||this.createRange(),a=o.toString()!==r
"string"==typeof n&&(n=n.trim()),n=s.onCreateLink?s.onCreateLink(n):/^[A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?/.test(n)?n:"http://"+n
var u=[]
if(a){o=o.deleteContents()
var l=o.insertNode(e("<A>"+r+"</A>")[0])
u.push(l)}else u=h.styleNodes(o,{nodeName:"A",expandClosestSibling:!0,onlyPartialContains:!0})
e.each(u,function(t,r){e(r).attr("href",n),i?e(r).attr("target","_blank"):e(r).removeAttr("target")})
var c=M.createFromNodeBefore(p.head(u)),f=c.getStartPoint(),d=M.createFromNodeAfter(p.last(u)),m=d.getEndPoint()
M.create(f.node,f.offset,m.node,m.offset).select()}),this.getLinkInfo=function(){var t=this.createRange().expand(d.isAnchor),n=e(p.head(t.nodes(d.isAnchor))),r={range:t,text:t.toString(),url:n.length?n.attr("href"):""}
...
t.triggerEvent("media.delete",n,o)}),this.hasFocus=function(){return o.is(":focus")},this.focus=function(){this.hasFocus()||o.focus()},this.isEmpty=function(){return d.isEmpty(o[0])||d.emptyPara===o.html()},this.empty=function(){t.invoke("code",d.emptyPara)}},G=function(t){var n=this,r=t.layoutInfo.editable
this.events={"summernote.keydown":function(e,r){n.needKeydownHook()&&(r.ctrlKey||r.metaKey)&&r.keyCode===L.code.V&&(t.invoke("editor.saveRange"),n.$paste.focus(),setTimeout(function(){n.pasteByHook()},0))}},this.needKeydownHook=function(){return c.isMSIE&&c.browserVersion>10||c.isFF},this.initialize=function(){this.needKeydownHook()?(this.$paste=e('<div tabindex="-1" />').attr("contenteditable",!0).css({position:"absolute",left:-1e5,opacity:0}),r.before(this.$paste),this.$paste.on("paste",function(e){t.triggerEvent("paste",e)})):r.on("paste",this.pasteByEvent)},this.destroy=function(){this.needKeydownHook()&&(this.$paste.remove(),this.$paste=null)},this.pasteByHook=function(){var n=this.$paste[0].firstChild,r=n&&n.src
if(d.isImg(n)&&0===r.indexOf("data:")){for(var i=atob(n.src.split(",")[1]),o=new Uint8Array(i.length),s=0;s<i.length;s++)o[s]=i.charCodeAt(s)
...
if(n&&n.items&&n.items.length){var r=p.head(n.items)
"file"===r.kind&&-1!==r.type.indexOf("image/")&&t.invoke("editor.insertImagesOrCallback",[r.getAsFile()]),t.invoke("editor.afterCommand")}}},$=function(t){var n=e(document),r=t.layoutInfo.editor,i=t.layoutInfo.editable,o=t.options,s=o.langInfo,a={},u=e(['<div class="note-dropzone">','  <div class="note-dropzone-message"/>',"</div>"].join("")).prependTo(r),l=function(){Object.keys(a).forEach(function(e){n.off(e.substr(2).toLowerCase(),a[e])}),a={}}
...
n||o.length||!i||(r.addClass("dragover"),u.width(r.width()),u.height(r.height()),l.text(s.image.dragImageHere)),o=o.add(e.target)},a.onDragleave=function(e){o=o.not(e.target),o.length||r.removeClass("dragover")},a.onDrop=function(){o=e(),r.removeClass("dragover")},n.on("dragenter",a.onDragenter).on("dragleave",a.onDragleave).on("drop",a.onDrop),u.on("dragenter",function(){u.addClass("hover"),l.text(s.image.dropImage)}).on("dragleave",function(){u.removeClass("hover"),l.text(s.image.dragImageHere)}),u.on("drop",function(n){var r=n.originalEvent.dataTransfer
...
i.toLowerCase().indexOf("text")>-1?t.invoke("editor.pasteHTML",o):e(o).each(function(){t.invoke("editor.insertNode",this)})})}).on("dragover",!1)},this.destroy=function(){l()}}
c.hasCodeMirror&&(c.isSupportAmd?require(["codemirror"],function(e){W=e}):W=window.CodeMirror)
var Q=function(e){var t=e.layoutInfo.editor,n=e.layoutInfo.editable,r=e.layoutInfo.codable,i=e.options
this.sync=function(){this.isActivated()&&c.hasCodeMirror&&r.data("cmEditor").save()},this.isActivated=function(){return t.hasClass("codeview")},this.toggle=function(){this.isActivated()?this.deactivate():this.activate(),e.triggerEvent("codeview.toggled")},this.activate=function(){if(r.val(d.html(n,i.prettifyHtml)),r.height(n.height()),e.invoke("toolbar.updateCodeview",!0),t.addClass("codeview"),r.focus(),c.hasCodeMirror){var o=W.fromTextArea(r[0],i.codemirror)
if(i.codemirror.tern){var s=new W.TernServer(i.codemirror.tern)
o.ternServer=s,o.on("cursorActivity",function(e){s.updateArgHints(e)})}o.setSize(null,n.outerHeight()),r.data("cmEditor",o)}},this.deactivate=function(){if(c.hasCodeMirror){var o=r.data("cmEditor")
r.val(o.getValue()),o.toTextArea()}var s=d.value(r,i.prettifyHtml)||d.emptyPara,a=n.html()!==s
n.html(s),n.height(i.height?r.height():"auto"),t.removeClass("codeview"),a&&e.triggerEvent("change",n.html(),n),n.focus(),e.invoke("toolbar.updateCodeview",!1)},this.destroy=function(){this.isActivated()&&this.deactivate()}},Y=function(t){var n=e(document),r=t.layoutInfo.statusbar,i=t.layoutInfo.editable,o=t.options
this.initialize=function(){if(o.airMode||o.disableResizeEditor)return void this.destroy()
r.on("mousedown",function(e){e.preventDefault(),e.stopPropagation()
...
n.on("mousemove",r).one("mouseup",function(){n.off("mousemove",r)})})},this.destroy=function(){r.off(),r.remove()}},X=function(t){var n=this,r=t.layoutInfo.editor,i=t.layoutInfo.toolbar,o=t.layoutInfo.editable,s=t.layoutInfo.codable,a=e(window),u=e("html, body")
this.resizeTo=function(e){o.css("height",e.h),s.css("height",e.h),s.data("cmeditor")&&s.data("cmeditor").setsize(null,e.h)},this.onResize=function(){n.resizeTo({h:a.height()-i.outerHeight()})},this.toggle=function(){r.toggleClass("fullscreen"),this.isFullscreen()?(o.data("orgHeight",o.css("height")),a.on("resize",this.onResize).trigger("resize"),u.css("overflow","hidden")):(a.off("resize",this.onResize),this.resizeTo({h:o.data("orgHeight")}),u.css("overflow","visible")),t.invoke("toolbar.updateFullscreen",this.isFullscreen())},this.isFullscreen=function(){return r.hasClass("fullscreen")}},J=function(t){var n=this,r=e(document),i=t.layoutInfo.editingArea,o=t.options
this.events={"summernote.mousedown":function(e,t){n.update(t.target)&&t.preventDefault()},"summernote.keyup summernote.scroll summernote.change summernote.dialog.shown":function(){n.update()},"summernote.disable":function(){n.hide()},"summernote.codeview.toggled":function(){n.update()}},this.initialize=function(){this.$handle=e(['<div class="note-handle">','<div class="note-control-selection">','<div class="note-control-selection-bg"></div>','<div class="note-control-holder note-control-nw"></div>','<div class="note-control-holder note-control-ne"></div>','<div class="note-control-holder note-control-sw"></div>','<div class="',o.disableResizeImage?"note-control-holder":"note-control-sizing",' note-control-se"></div>',o.disableResizeImage?"":'<div class="note-control-selection-info"></div>',"</div>","</div>"].join("")).prependTo(i),this.$handle.on("mousedown",function(e){if(d.isControlSizing(e.target)){e.preventDefault(),e.stopPropagation()
...
var r=d.isImg(n),i=this.$handle.find(".note-control-selection")
...
return r},this.hide=function(){t.invoke("editor.clearTarget"),this.$handle.children().hide()}},Z=function(t){var n=this,r=/^([A-Za-z][A-Za-z0-9+-.]*\:[\/\/]?|mailto:[A-Z0-9._%+-]+@)?(www\.)?(.+)$/i
...
this.lastWordRange.insertNode(s),this.lastWordRange=null,t.invoke("editor.focus")}}},this.handleKeydown=function(e){if(p.contains([L.code.ENTER,L.code.SPACE],e.keyCode)){var n=t.invoke("editor.createRange").getWordRange()
this.lastWordRange=n}},this.handleKeyup=function(e){p.contains([L.code.ENTER,L.code.SPACE],e.keyCode)&&this.replace()}},ee=function(e){var t=e.layoutInfo.note
this.events={"summernote.change":function(){t.val(e.invoke("code"))}},this.shouldInitialize=function(){return d.isTextarea(t[0])}},te=function(t){var n=this,r=t.layoutInfo.editingArea,i=t.options
...
this.$placeholder.toggle(e)}},ne=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.toolbar,o=t.options,s=o.langInfo,a=f.invertObject(o.keyMap[c.isMac?"mac":"pc"]),u=this.representShortcut=function(e){var t=a[e]
return o.shortcuts&&t?(c.isMac&&(t=t.replace("CMD","⌘").replace("SHIFT","⇧"))," ("+(t=t.replace("BACKSLASH","\\").replace("SLASH","/").replace("LEFTBRACKET","[").replace("RIGHTBRACKET","]"))+")"):""}
this.initialize=function(){this.addToolbarButtons(),this.addImagePopoverButtons(),this.addLinkPopoverButtons(),this.addTablePopoverButtons(),this.fontInstalledMap={}},this.destroy=function(){delete this.fontInstalledMap},this.isFontInstalled=function(e){return n.fontInstalledMap.hasOwnProperty(e)||(n.fontInstalledMap[e]=c.isFontInstalled(e)||p.contains(o.fontNamesIgnoreCheck,e)),n.fontInstalledMap[e]},this.addToolbarButtons=function(){t.memo("button.style",function(){return r.buttonGroup([r.button({className:"dropdown-toggle",contents:r.dropdownButtonContents(r.icon(o.icons.magic),o),tooltip:s.style.style,data:{toggle:"dropdown"}}),r.dropdown({className:"dropdown-style",items:t.options.styleTags,template:function(e){"string"==typeof e&&(e={tag:e,title:s.style.hasOwnProperty(e)?s.style[e]:e})
...
a.css({width:c.c+"em",height:c.r+"em"}),s.data("value",c.c+"x"+c.r),3<c.c&&c.c<o.insertTableMaxSize.col&&u.css({width:c.c+1+"em"}),3<c.r&&c.r<o.insertTableMaxSize.row&&u.css({height:c.r+1+"em"}),i.html(c.c+" x "+c.r)}},re=function(t){var n=e.summernote.ui,r=t.layoutInfo.note,i=t.layoutInfo.editor,o=t.layoutInfo.toolbar,s=t.options
...
e||(t=t.not(".btn-codeview")),n.toggleBtn(t,!1)}},ie=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.editor,o=t.options,s=o.langInfo
...
t.invoke("editor.saveRange"),this.showLinkDialog(e).then(function(e){t.invoke("editor.restoreRange"),t.invoke("editor.createLink",e)}).fail(function(){t.invoke("editor.restoreRange")})},t.memo("help.linkDialog.show",o.langInfo.help["linkDialog.show"])},oe=function(t){var n=this,r=e.summernote.ui,i=t.options
this.events={"summernote.keyup summernote.mouseup summernote.change summernote.scroll":function(){n.update()},"summernote.disable summernote.dialog.shown":function(){n.hide()}},this.shouldInitialize=function(){return!p.isEmpty(i.popover.link)},this.initialize=function(){this.$popover=r.popover({className:"note-link-popover",callback:function(e){e.find(".popover-content,.note-popover-content").prepend('<span><a target="_blank"></a>&nbsp;</span>')}}).render().appendTo("body")
var e=this.$popover.find(".popover-content,.note-popover-content")
t.invoke("buttons.build",e,i.popover.link)},this.destroy=function(){this.$popover.remove()},this.update=function(){if(!t.invoke("editor.hasFocus"))return void this.hide()
var n=t.invoke("editor.createRange")
if(n.isCollapsed()&&n.isOnAnchor()){var r=d.ancestor(n.sc,d.isAnchor),i=e(r).attr("href")
this.$popover.find("a").attr("href",i).html(i)
var o=d.posFromPlaceholder(r)
this.$popover.css({display:"block",left:o.left,top:o.top})}else this.hide()},this.hide=function(){this.$popover.hide()}},se=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.editor,o=t.options,s=o.langInfo
...
r.toggleBtn(s,e)}).val("").trigger("focus"),n.bindEnterKey(o,s)}),r.onDialogHidden(n.$dialog,function(){i.off("change"),o.off("keyup paste keypress"),s.off("click"),"pending"===e.state()&&e.reject()}),r.showDialog(n.$dialog)})}},ae=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.editable,o=i[0],s=t.options
this.events={"summernote.disable":function(){n.hide()}},this.shouldInitialize=function(){return!p.isEmpty(s.popover.image)},this.initialize=function(){this.$popover=r.popover({className:"note-image-popover"}).render().appendTo("body")
var e=this.$popover.find(".popover-content,.note-popover-content")
t.invoke("buttons.build",e,s.popover.image)},this.destroy=function(){this.$popover.remove()},this.update=function(e){if(d.isImg(e)){var t=d.posFromPlaceholder(e),n=d.posFromPlaceholder(o)
this.$popover.css({display:"block",left:t.left,top:Math.min(t.top,n.top)})}else this.hide()},this.hide=function(){this.$popover.hide()}},ue=function(t){var n=this,r=e.summernote.ui,i=t.options
this.events={"summernote.mousedown":function(e,t){n.update(t.target)},"summernote.keyup summernote.scroll summernote.change":function(){n.update()},"summernote.disable":function(){n.hide()}},this.shouldInitialize=function(){return!p.isEmpty(i.popover.table)},this.initialize=function(){this.$popover=r.popover({className:"note-table-popover"}).render().appendTo("body")
var e=this.$popover.find(".popover-content,.note-popover-content")
t.invoke("buttons.build",e,i.popover.table),c.isFF&&document.execCommand("enableInlineTableEditing",!1,!1)},this.destroy=function(){this.$popover.remove()},this.update=function(e){if(t.isDisabled())return!1
var n=d.isCell(e)
if(n){var r=d.posFromPlaceholder(e)
this.$popover.css({display:"block",left:r.left,top:r.top})}else this.hide()
return n},this.hide=function(){this.$popover.hide()}},le=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.editor,o=t.options,s=o.langInfo
...
r.onDialogShown(n.$dialog,function(){t.triggerEvent("dialog.shown"),o.val(i).on("input",function(){r.toggleBtn(s,o.val())}).trigger("focus"),s.click(function(t){t.preventDefault(),e.resolve(o.val())}),n.bindEnterKey(o,s)}),r.onDialogHidden(n.$dialog,function(){o.off("input"),s.off("click"),"pending"===e.state()&&e.reject()}),r.showDialog(n.$dialog)})}},ce=function(t){var n=this,r=e.summernote.ui,i=t.layoutInfo.editor,o=t.options,s=o.langInfo
this.createShortCutList=function(){var n=o.keyMap[c.isMac?"mac":"pc"]
...
this.$dialog=r.dialog({title:s.options.help,fade:o.dialogsFade,body:this.createShortCutList(),footer:n,callback:function(e){e.find(".modal-body,.note-modal-body").css({"max-height":300,overflow:"scroll"})}}).render().appendTo(t)},this.destroy=function(){r.hideDialog(this.$dialog),this.$dialog.remove()},this.showHelpDialog=function(){return e.Deferred(function(e){r.onDialogShown(n.$dialog,function(){t.triggerEvent("dialog.shown"),e.resolve()}),r.showDialog(n.$dialog)}).promise()},this.show=function(){t.invoke("editor.saveRange"),this.showHelpDialog().then(function(){t.invoke("editor.restoreRange")})}},fe=function(t){var n=this,r=e.summernote.ui,i=t.options
this.events={"summernote.keyup summernote.mouseup summernote.scroll":function(){n.update()},"summernote.disable summernote.change summernote.dialog.shown":function(){n.hide()},"summernote.focusout":function(e,t){c.isFF||t.relatedTarget&&d.ancestor(t.relatedTarget,f.eq(n.$popover[0]))||n.hide()}},this.shouldInitialize=function(){return i.airMode&&!p.isEmpty(i.popover.air)},this.initialize=function(){this.$popover=r.popover({className:"note-air-popover"}).render().appendTo("body")
...
if(e.range&&!e.range.isCollapsed()){var n=p.last(e.range.getClientRects())
if(n){var r=f.rect2bnd(n)
this.$popover.css({display:"block",left:Math.max(r.left+r.width/2,0)-20,top:r.top+r.height}),t.invoke("buttons.updateCurrentStyle",this.$popover)}}else this.hide()},this.hide=function(){this.$popover.hide()}},pe=function(t){var n=this,r=e.summernote.ui,i=t.options.hint||[],o=t.options.hintDirection||"bottom",s=e.isArray(i)?i:[i]
...
this.lastWordRange.insertNode(n),M.createFromNode(n).collapse().select(),this.lastWordRange=null,this.hide(),t.triggerEvent("change",t.layoutInfo.editable.html(),t.layoutInfo.editable),t.invoke("editor.focus")}},this.nodeFromItem=function(e){var t=s[e.data("index")],n=e.data("item"),r=t.content?t.content(n):n
return"string"==typeof r&&(r=d.createText(r)),r},this.createItemTemplates=function(t,n){var r=s[t]
return n.map(function(n,i){var o=e('<div class="note-hint-item"/>')
return o.append(r.template?r.template(n):n+""),o.data({index:t,item:n}),0===t&&0===i&&o.addClass("active"),o})},this.handleKeydown=function(e){this.$popover.is(":visible")&&(e.keyCode===L.code.ENTER?(e.preventDefault(),this.replace()):e.keyCode===L.code.UP?(e.preventDefault(),this.moveUp()):e.keyCode===L.code.DOWN&&(e.preventDefault(),this.moveDown()))},this.searchKeyword=function(e,t,n){var r=s[e]
...
return this.searchKeyword(t,r,function(e){e=e||[],e.length&&(i.html(n.createItemTemplates(t,e)),n.show())}),i},this.handleKeyup=function(e){if(p.contains([L.code.ENTER,L.code.UP,L.code.DOWN],e.keyCode)){if(e.keyCode===L.code.ENTER&&this.$popover.is(":visible"))return}else{var r=t.invoke("editor.createRange").getWordRange(),i=r.toString()
if(s.length&&i){this.$content.empty()
var a=f.rect2bnd(p.last(r.getClientRects()))
...
e.default=r.extend({layout:t.default,lang:null,height:120,focus:!1,content:null,airMode:!1,callbacks:null,disabled:!1,shortcuts:!1,summernote:null,btnSize:"btn-xs",dialogsFade:!0,dialogsInBody:!1,disableDragAndDrop:!1,toolbar:[["fontname",["fontname"]],["fontsize",["fontsize"]],["style",["style"]],["color",["color"]],["height",["height"]],["table",["table"]],["para",["ul","ol","paragraph"]],["font",["bold","italic","underline","superscript","subscript","strikethrough","clear"]],["insert",["link","picture","video","hr"]],["view",["undo","redo","codeview","fullscreen"]]],summernoteOptions:function(){var e=this,t={},n=this.get("toolbar"),r=this.get("buttons")||[],i=this.get("callbacks")||{}
i.onChange=this.get("onContentChange")||function(t){return e.set("content",t)}
var o=this.getProperties(["height","focus","lang","airMode","shortcuts","dialogsInBody","dialogsFade","disableDragAndDrop"])
...
var s=e.ModuleRegistry=function(){function e(t){r(this,e),this._entries=t||requirejs.entries}return e.prototype.moduleNames=function(){return Object.keys(this._entries)},e.prototype.has=function(e){return e in this._entries},e.prototype.get=function(e){return require(e)},e}(),a=Ember.String,u=a.underscore,l=a.classify,c=a.dasherize,f=Ember.get,p=Ember.DefaultResolver,h=p.extend({resolveOther:o,parseName:i,resolveTemplate:o,pluralizedTypes:null,moduleRegistry:null,makeToString:function(e,t){return this.namespace.modulePrefix+"@"+t+":"},shouldWrapInClassFactory:function(){return!1},init:function(){this._super(),this.moduleBasedResolver=!0,this._moduleRegistry||(this._moduleRegistry=new s),this._normalizeCache=(0,n.default)(),this.pluralizedTypes=this.pluralizedTypes||(0,n.default)(),this.pluralizedTypes.config||(this.pluralizedTypes.config="config"),this._deprecatedPodModulePrefix=!1},normalize:function(e){return this._normalizeCache[e]||(this._normalizeCache[e]=this._normalize(e))},_normalize:function(e){var t=e.split(":")
